...
@section('page_meta')
    ...
    <title>
        لوحة تحكم منصة تعليم البرمجة اونلاين | عرض الكورس
    </title>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">عرض كورس</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">عرض: {{ $course_info->name }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                @can('تعديل كورس')
                    <div class="col-12 col-sm-12 d-flex justify-content-end align-items-center px-1 mb-2">
                        <a href="/control/courses/{{ $course_info->id }}/edit" class="btn btn-primary">تعديل
                            الكورس</a>
                    </div>
                @endcan
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <img data-action="zoom" class="img-fluid2" data-action="zoom"
