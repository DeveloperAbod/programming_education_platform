...
@section('page_meta')
    ...
    <title>
        لوحة تحكم منصة تعليم البرمجة اونلاين | اضافة كورس جديد
    </title>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">اضافة كورس جديد</h3>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        <form novalidate class="form" action="/control/courses/store" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="name"
                                                                    ...
                                                                    placeholder="ادخل اسم  الكورس" minlength="6"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="shortcut"
                                                                    value="{{ old('shortcut') }}" class="form-control mb-1"
                                                                    placeholder="ادخل الاختصار"
                                                            ...
                                                            <div class="controls">
                                                                <div class="input-group">
                                                                    <input type="text" name="price"
                                                                        ...
                                                                        placeholder="ادخل السعر" pattern="^\d+(\.\d{1,2})?$"
                                                                        required
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <h5>
                                                                <span class="required">*</span>الصورة الاساسية
                                                            </h5>
                                                            <div class="controls">
                                                                <input type="file" name="image"
                                                                    ...
                                                                    data-validation-required-message="لا يمكن ان تكون الصورة فارغاً"
                                                                    aria-invalid="false">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <textarea name="description" id="textarea" class="form-control " required="" placeholder="الوصف"
                                                                    minlength="10" data-validation-required-message="لا يمكن ان  يكون الوصف فارغاً" aria-invalid="false">{{ old('description') }}</textarea>
                                                                @error('description')
                                                                    <div class="form-text text-danger">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="d-inline-block custom-control custom-checkbox mr-1">
                                                            ...
                                                            <label class="custom-control-label" for="status">تفعيل
                                                                الكورس</label>
                                                            <small class="text-muted">سيتم تفعيل الكورس بعد الموافقة
                                                                عليه</small>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="d-inline-block custom-control custom-checkbox mr-1">
                                                            <input type="checkbox" class="custom-control-input"
                                                                name="trending"
                                                                @if (old('trending') == 'on') checked @endif
                                                                id="trending" />
                                                            <label class="custom-control-label" for="trending">جعل الكورس
                                                                رائج</label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check-square-o"></i>اضافة الكورس
                                                </button>
