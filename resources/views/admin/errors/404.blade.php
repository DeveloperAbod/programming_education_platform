                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-lg-4 col-md-8 col-10 p-0">
                            <div class="card-header bg-transparent border-0">
                                ...
                                <h3 class="text-uppercase text-center">هذه الصفحة غير موجودة</h3>
                                <h5 class="text-uppercase text-center">عذرا، لا يمكن العثور على الصفحة التي تبحث عنها.
                                    إنه مجرد حادث لم يكن مقصودًا.. </h5>

                            </div>
                            <div class="card-content">
                                <div class="row py-2">
                                    <div class="col-12 col-sm-12 col-md-12 mb-1">
                                        <a href="/control/" class="btn btn-primary btn-block"><i class="ft-home"></i>
                            ...
                            <div class="card-footer bg-transparent">
                                <div class="row">
                                    <p class="text-muted text-center col-12 pb-1">
                                        منصة تعليم البرمجة اونلاين
                                        © <span class="year"></span>
                                        <a href="#">تم التصميم والتطوير
                                            <i class="ft-heart pink"> </i> من قبل
                                            <a href="https://devabod.online/" target="_blank">المطور عبود</a>
                                    </p>
