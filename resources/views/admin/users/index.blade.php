                ...
                @can('اضافة مستخدم')
                    <div class="content-header-right col-md-6 col-12">
                        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                            <a href="/control/users/create" class="btn btn-info round  box-shadow-2 px-2 mb-1"><i
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu" x-placement="bottom-start"
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                            href="/control/users/{{ $item->id }}/show">عرض</a>

                                                                        @can('تعديل مستخدم')
                                                                            <a class="dropdown-item"
                                                                                href="/control/users/{{ $item->id }}/edit">تعديل</a>
                                                                        @endcan
                                                                        @can('حذف مستخدم')
        ...
        $(document).on('click', '.delete_user_btn', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url = "/control/users/" + id + "/delete";
