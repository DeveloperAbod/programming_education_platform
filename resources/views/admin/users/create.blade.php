...
@section('page_meta')
    ...
    <title>
        لوحة تحكم منصة تعليم البرمجة اونلاين | اضافة مستخدم جديد
    </title>
@endsection
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        <form novalidate class="form" action="/control/users/store" method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="phone"
                                                                    ...
                                                                    placeholder="ادخل رقم هاتف المستخدم" required=""
