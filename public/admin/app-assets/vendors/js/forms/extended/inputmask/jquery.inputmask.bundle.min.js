      ...
      function (module, exports, __webpack_require__) {
        ...
        module.exports = function maskScope(actionObj, maskset, opts) {
          ...
          function refreshFromBuffer(start, end, buffer) {
            ...
            if (((opts.skipOptionalPartCharacter = ""), !0 === start))
              resetMaskSet(),
                ...
                (start = 0),
                (end = buffer.length),
                (p = determineNewCaretPosition({ begin: 0, end: 0 }, !1));
            else {
          ...
          function seekNext(pos, newBlock) {
            for (
              ...
              ((!0 === newBlock &&
                ...
                (!0 !== newBlock && !isMask(position, void 0, !0)));
          ...
          function handleRemove(input, k, pos, strict, fromIsValid) {
            ...
            if (
              (k === keyCode.BACKSPACE ||
              (k === keyCode.DELETE && !1 === opts.insertMode)
                ? pos.end - pos.begin < 1 &&
                ...
                : !0 !== strict &&
                  ...
                  !1 === opts.insertMode &&
                    ...
                    void 0 === maskset.validPositions[maskset.p] &&
                      getLastValidPosition(maskset.maskLength, !0) <
                        maskset.p &&
