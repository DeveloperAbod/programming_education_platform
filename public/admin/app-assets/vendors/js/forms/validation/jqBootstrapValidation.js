  ...
  var defaults = {
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("maxlength") !== undefined) {
              message =
                "Too long: Maximum of '" +
                $this.attr("maxlength") +
                "' خانة<!-- data-validation-maxlength-message to override -->";
            ...
            if ($this.attr("minlength") !== undefined) {
              message =
                "يجب كتابة '" +
                $this.attr("minlength") +
                "' خانة<!-- data-validation-minlength-message to override -->";
            ...
            if (
              ...
              message =
                "يجب كتابة ايميل صحيح<!-- data-validation-email-message to override -->";
    ...
    validatorTypes: {
      ...
      email: {
        ...
        init: function ($this, name) {
          ...
          var message = "يجب كتابة ايميل صحيح";
          if ($this.data("validation" + name + "Message")) {
            message = $this.data("validation" + name + "Message");
          }
      ...
      maxlength: {
        ...
        init: function ($this, name) {
          ...
          result.message =
            "يجب الا يتجاوز '" + result.maxlength + "' حروف";
          if ($this.data("validation" + name + "Message")) {
            result.message = $this.data("validation" + name + "Message");
          }
      ...
      minlength: {
        ...
        init: function ($this, name) {
          ...
          result.message =
            "يجب الا يتجاوز'" + result.minlength + "'خانة";
          if ($this.data("validation" + name + "Message")) {
            result.message = $this.data("validation" + name + "Message");
          }
    ...
    builtInValidators: {
      ...
      required: {
        ...
        type: "required",
        message:
          "هذا الحقل مطلوب<!-- data-validator-required-message to override -->",
      },
      checkone: {
        name: "Checkone",
        type: "minchecked",
