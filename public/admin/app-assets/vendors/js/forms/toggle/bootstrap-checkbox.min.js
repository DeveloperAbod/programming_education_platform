...
!(function (factory) {
  ...
  var Checkboxpicker = (function () {
      function Checkboxpicker(element, options) {
        (this.element = element), (this.$element = $(element));
        var data = this.$element.data();
        "" === data.reverse && (data.reverse = !0),
          "" === data.switchAlways && (data.switchAlways = !0),
          "" === data.html && (data.html = !0),
          (this.options = $.extend(
            {},
          ...
          this.$element.closest("label").length
            ? console.warn(this.options.warningMessage)
            : ((this.$group = $(document.createElement("div"))),
              (this.$buttons = create("button", "button")
                .attr("type", "button")
                .attr("tabindex", -1)),
      ...
      return (
        (_proto.init = function () {
          ...
          (this.element.hidden = !0),
            this.$group
              .addClass(this.options.baseGroupCls)
              .addClass(this.options.groupCls),
            this.$buttons
              .addClass(this.options.baseCls)
              .addClass(this.options.cls),
            this.options.offLabel && this.$off[fn](this.options.offLabel),
            this.options.onLabel && this.$on[fn](this.options.onLabel),
            this.options.offIconCls &&
              (this.options.offLabel && this.$off.prepend("&nbsp;"),
              create("span")
                .addClass(this.options.iconCls)
                .addClass(this.options.offIconCls)
                .prependTo(this.$off)),
            this.options.onIconCls &&
              (this.options.onLabel && this.$on.prepend("&nbsp;"),
              create("span")
                .addClass(this.options.iconCls)
                .addClass(this.options.onIconCls)
                .prependTo(this.$on)),
        ...
        (_proto.toggleDisabled = function () {
        ...
        (_proto.click = function (event) {
          ($(event.currentTarget).hasClass("active") &&
            !this.options.switchAlways) ||
            this.change();
        }),
        (_proto.change = function () {
          this.set(!this.element.checked);
        }),
        (_proto.set = function (value) {
          (this.element.checked = value), this.$element.trigger("change");
        }),
        (_proto.keydown = function (event) {
          -1 !== $.inArray(event.keyCode, this.options.toggleKeyCodes)
            ? (event.preventDefault(), this.change())
            : 13 === event.keyCode && $(this.element.form).trigger("submit");
        }),
        (_proto.reset = function () {
          ((this.element.defaultChecked && this.$off.hasClass("active")) ||
            (!this.element.defaultChecked && this.$on.hasClass("active"))) &&
            this.set(this.element.defaultChecked);
        }),
        Checkboxpicker
      );
    })(),
    oldPropHooks = $.extend({}, $.propHooks);
  return (
    $.extend($.propHooks, {
      checked: {
        set: function (element, value) {
          var data = $.data(element, "bs.checkbox");
          data && element.checked !== value && data.change(value),
            oldPropHooks.checked &&
              oldPropHooks.checked.set &&
      ...
      disabled: {
        set: function (element, value) {
          var data = $.data(element, "bs.checkbox");
          data && element.disabled !== value && data.toggleDisabled(),
            oldPropHooks.disabled &&
              oldPropHooks.disabled.set &&
    ...
    ($.fn.checkboxpicker = function (options, elements) {
      return (
        this instanceof $
          ? this
          : $("string" == typeof options ? options : elements)
      ).each(function () {
