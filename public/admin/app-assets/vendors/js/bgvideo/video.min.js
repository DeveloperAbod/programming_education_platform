!(function (t, e) {
    ...
    return (
      Object.getOwnPropertyNames(e).forEach(function (t) {
        ...
        -1 !== t.indexOf("aria-") || "role" === t || "type" === t
          ? (Xe.warn(qe(Ke, t, n)), i.setAttribute(t, n))
          : "textContent" === t
          ? y(i, n)
          : (i[t] = n);
      }),
  ...
  function U(t) {
    ...
    if (!t || !t.isPropagationStopped) {
      ...
      if (
        (t.target || (t.target = t.srcElement || ue),
        t.relatedTarget ||
          (t.relatedTarget =
  ...
  function yt(t) {
          ...
          0 !== e
            ? ((r = {
              ...
              a.getAllResponseHeaders &&
                (r.headers = lr(a.getAllResponseHeaders())))
    ...
    a ||
      (a =
        t.cors || t.useXDR ? new vt.XDomainRequest() : new vt.XMLHttpRequest());
    var l,
      c,
      u,
      h = (a.url = t.uri || t.url),
  ...
  function kt(t, e, n) {
    function r() {
      var e = bt(t);
      if (null === e)
        throw new _t(_t.Errors.BadTimeStamp, "Malformed timestamp: " + o);
  ...
  function St(t) {
    ...
    for (e(i, t); (o = n(i)); )
      for (var s = 0; s < o.length; s++)
        if (((r = o.charCodeAt(s)), Et(r))) return "rtl";
    return "ltr";
  }
  function xt(t) {
    if (
  ...
  function te(t, e, n) {
    ...
    if (r.player || lo.players[r.playerId])
      return r.player || lo.players[r.playerId];
    (e = e || {}),
      te.hooks("beforesetup").forEach(function (t) {
        var n = t(r, Z(e));
        if (!i(n) || Array.isArray(n))
          return void Xe.error("please return an object in beforesetup hooks");
        e = Z(e, n);
      });
    var s = Tn.getComponent("Player"),
      a = new s(r, e, n);
    return (
      te.hooks("setup").forEach(function (t) {
        return t(a);
      }),
      a
    );
  ...
  var ie,
    oe = ee,
    se = {},
    ae = (Object.freeze || Object)({ default: se }),
    le = (ae && se) || ae,
    ce = void 0 !== re ? re : "undefined" != typeof window ? window : {};
  "undefined" != typeof document
    ? (ie = document)
    : (ie = ce["__GLOBAL_DOCUMENT_CACHE@4"]) ||
      (ie = ce["__GLOBAL_DOCUMENT_CACHE@4"] = le);
  var ue = ie,
    ...
    je = (function () {
      var t = /MSIE\s(\d+)\.\d/.exec(he),
        e = t && parseFloat(t[1]);
      return (
        !e && /Trident\/7.0/i.test(he) && /rv:11.0/.test(he) && (e = 11), e
      );
    })(),
    ...
    Ne =
      h() &&
      ("ontouchstart" in oe ||
        (oe.DocumentTouch && oe.document instanceof oe.DocumentTouch)),
      ...
      off: function (t, e, n) {
        if (!t || dn(t)) X(this.eventBusEl_, t, e);
          ...
          fn(r),
            ...
            this.off("dispose", n),
            r.nodeName
              ? (X(r, i, n), X(r, "dispose", n))
              : pn(r) && (r.off(i, n), r.off("dispose", n));
        }
      },
    ...
    bn = {
      ...
      setState: function (t) {
        ...
        return (
          ...
          r && pn(this) && this.trigger({ changes: r, type: "statechanged" }),
          r
        );
      },
    },
    Tn = (function () {
      function t(e, n, r) {
        if (
          ...
          (this.options_ = Z({}, this.options_)),
          (n = this.options_ = Z(this.options_, n)),
      ...
      return (
        ...
        (t.prototype.options = function (t) {
          return (
            ...
            t
              ? ((this.options_ = Z(this.options_, t)), this.options_)
              : this.options_
          );
        }),
        ...
        (t.prototype.dimension = function (t, e, n) {
          ...
          return -1 !== i
            ...
            : parseInt(this.el_["offset" + J(t)], 10);
        }),
  ...
  (Tn.prototype.supportsRaf_ =
    "function" == typeof oe.requestAnimationFrame &&
    "function" == typeof oe.cancelAnimationFrame),
  ...
  for (var jn = 0; jn < ot.errorTypes.length; jn++)
    (ot[ot.errorTypes[jn]] = jn), (ot.prototype[ot.errorTypes[jn]] = jn);
  var An = st,
    Pn = function (t) {
      return [
        "kind",
    ...
    Mn = { textTracksToJson: Nn, jsonToTextTracks: On, trackToJson_: Pn },
    In = "vjs-modal-dialog",
    Dn = (function (t) {
      function e(n, r) {
        De(this, e);
      ...
      return (
        ...
        (e.prototype.conditionalFocus_ = function () {
          ...
          (this.previouslyActiveEl_ = null),
            (e.contains(t) || e === t) &&
              ...
              this.focus(),
              this.on(ue, "keydown", this.handleKeyDown));
        }),
        ...
        (e.prototype.focusableEls_ = function () {
          ...
          return Array.prototype.filter.call(t, function (t) {
            return (
              ((t instanceof oe.HTMLAnchorElement ||
                t instanceof oe.HTMLAreaElement) &&
                t.hasAttribute("href")) ||
              ((t instanceof oe.HTMLInputElement ||
                t instanceof oe.HTMLSelectElement ||
                t instanceof oe.HTMLTextAreaElement ||
                t instanceof oe.HTMLButtonElement) &&
  ...
  (Dn.prototype.options_ = { pauseOnOpen: !0, temporary: !0 }),
  ...
  var Bn = function (t, e) {
    ...
    Fn = (function (t) {
      function e() {
        ...
        if (xe) {
          ...
          for (var a in Ln.prototype)
            "constructor" !== a && (o[a] = Ln.prototype[a]);
    ...
    Wn = (function (t) {
      function e() {
        ...
        if (xe) {
          o = ue.createElement("custom");
          for (var s in Ln.prototype)
            "constructor" !== s && (o[s] = Ln.prototype[s]);
    ...
    Yn = { disabled: "disabled", hidden: "hidden", showing: "showing" },
    Gn = (function (t) {
      function e() {
        var n,
          r =
  ...
  (vt.XMLHttpRequest = oe.XMLHttpRequest || mt),
    (vt.XDomainRequest =
      "withCredentials" in new vt.XMLHttpRequest()
        ? vt.XMLHttpRequest
        : oe.XDomainRequest),
    (function (t, e) {
      ...
      (n.oncue = function (t) {
        ...
        r.length > 0 &&
          (oe.console &&
            ...
            oe.console.groupCollapsed("Text Track parsing errors for " + e.src),
  ...
  (_r.prototype.allowedEvents_ = { load: "load" }),
    (_r.NONE = gr),
    (_r.LOADING = 1),
    (_r.LOADED = mr),
    (_r.ERROR = 3);
  ...
  var Ar = Ot,
    Pr = "auto",
    Nr = { "": !0, lr: !0, rl: !0 },
    Or = { start: !0, middle: !0, end: !0, left: !0, right: !0 };
    ...
    Rr = (function (t) {
      ...
      return (
        ...
        (e.prototype.error = function (t) {
          return (
            void 0 !== t && ((this.error_ = new ot(t)), this.trigger("error")),
            this.error_
          );
        }),
        ...
        (t.prototype.setSource = function (e) {
          ...
          n ||
            (t.nativeSourceHandler
              ...
              : Xe.error("No source hander found for the current source.")),
  ...
  var Br = {},
    Fr = { buffered: 1, currentTime: 1, duration: 1, seekable: 1, played: 1 },
    Vr = { setCurrentTime: 1 },
    Hr = function t(e) {
      if (Array.isArray(e)) {
        var n = [];
  ...
  var Xr = {
    ...
    qr = (function (t) {
      function e(n, r, i) {
        ...
        return (
          n.on("loadstart", cn(o, o.toggleDisplay)),
      ...
      return (
        ...
        (e.prototype.clearDisplay = function () {
          "function" == typeof oe.WebVTT &&
            oe.WebVTT.processCues(oe, [], this.el_);
        }),
              ...
              if (o) {
                ...
                if (
                  ...
                  e.backgroundOpacity &&
                    Gt(
                      s.firstChild,
                      "backgroundColor",
                      Yt(e.backgroundColor || "#000", e.backgroundOpacity)
                    ),
                  e.windowColor &&
                    (e.windowOpacity
                      ? Gt(
                ...
                e.fontFamily &&
                  ...
                  ("small-caps" === e.fontFamily
                    ...
                    : (s.firstChild.style.fontFamily = Xr[e.fontFamily]));
              }
            }
          }
        }),
  ...
  var Qr = (function (t) {
    function e(n, r) {
      ...
      var i = Re(this, t.call(this, n, r));
      return (
        (i.throttledUpdateContent = un(cn(i, i.updateContent), 25)),
  ...
  var ti = (function (t) {
    function e(n, r) {
      ...
      var i = Re(this, t.call(this, n, r));
      return (
        i.on(n, ["durationchange", "loadedmetadata"], i.throttledUpdateContent),
        i
      );
    }
    return (
  ...
  (ai.prototype.options_ = { children: [] }),
    (je && !(je > 8)) ||
      ge ||
      _e ||
      ai.prototype.options_.children.push("timeTooltip"),
  ...
  (li.prototype.options_ = { children: ["timeTooltip"] }),
  ...
  (ci.prototype.options_ = {
    ...
    (je && !(je > 8)) ||
      ge ||
      _e ||
      ci.prototype.options_.children.splice(1, 0, "mouseTimeDisplay"),
  ...
  var ui = (function (t) {
    function e(n, r) {
      ...
      var i = Re(this, t.call(this, n, r));
      return (
        (i.handleMouseMove = un(cn(i, i.handleMouseMove), 25)),
  ...
  (ui.prototype.options_ = { children: ["seekBar"] }),
  ...
  (gi.prototype.options_ = { children: ["muteToggle", "volumeControl"] }),
  ...
  var wi = (function (t) {
    function e(n) {
      var r =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      return (
        De(this, e), (r.tracks = n.textTracks()), Re(this, t.call(this, n, r))
      );
    }
    return (
      Le(e, t),
      (e.prototype.createItems = function () {
        var t =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
          e =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Ci,
          n = void 0;
    ...
    return (
      ...
      (e.prototype.createItems = function () {
        ...
        for (var n = 0, r = e.length; n < r; n++) {
          var i = e[n],
            o = new Ei(this.player_, { track: this.track_, cue: i });
          t.push(o);
        }
        return t;
      }),
      ...
      (e.prototype.createItems = function () {
        ...
        return (
          (this.player().tech_ &&
            ...
            (e.push(new Ai(this.player_, { kind: this.kind_ })),
            (this.hideThreshold_ += 1)),
    ...
    return (
      ...
      (e.prototype.createItems = function () {
        ...
        return (
          (this.player().tech_ &&
            this.player().tech_.featuresNativeTextTracks) ||
            (e.push(new Ai(this.player_, { kind: this.label_ })),
            (this.hideThreshold_ += 1)),
  ...
  var Ii = (function (t) {
    function e(n) {
      var r =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      return (
        De(this, e), (r.tracks = n.audioTracks()), Re(this, t.call(this, n, r))
      );
    }
    return (
      Le(e, t),
      ...
      (e.prototype.createMenu = function () {
        ...
        if (e)
          for (var n = e.length - 1; n >= 0; n--)
            t.addChild(new Di(this.player(), { rate: e[n] + "x" }));
        return t;
      }),
  ...
  var Zi = (function (t) {
    function r(n, i) {
      ...
      return (
        (o.updateDisplay = cn(o, o.updateDisplay)),
        o.fill(),
        ...
        if (this.options_.persistTextTrackSettings) {
          ...
          try {
            Object.keys(t).length
              ? oe.localStorage.setItem(
                  "vjs-text-track-settings",
                  JSON.stringify(t)
                )
              : oe.localStorage.removeItem("vjs-text-track-settings");
          } catch (t) {
            Xe.warn(t);
          }
        }
      ...
      return (
        ...
        (e.prototype.createEl = function () {
          ...
          if (
            ...
            if (t) {
              ...
              var i = this.options_.tag && k(this.options_.tag),
                o = Z({}, i);
              (Ne && !0 === this.options_.nativeControlsForTouch) ||
                delete o.controls,
          ...
          void 0 !== this.options_.preload &&
            E(t, "preload", this.options_.preload);
          for (
        ...
        (e.prototype.getVideoPlaybackQuality = function () {
          ...
          return (
            ...
            oe.performance && "function" == typeof oe.performance.now
              ...
              : oe.performance &&
                oe.performance.timing &&
                "number" == typeof oe.performance.timing.navigationStart &&
                (t.creationTime =
                  oe.Date.now() - oe.performance.timing.navigationStart),
            t
          );
        }),
        e
  ...
  (eo.isSupported = function () {
    ...
    (eo.canControlPlaybackRate = function () {
      ...
      try {
        ...
        return (
          (eo.TEST_VID.playbackRate = t / 2 + 0.1),
    ...
    lo = (function (t) {
      ...
      return (
        ...
        (e.prototype.createEl = function () {
          ...
          (n = this.el_ =
            r ? e.parentNode : t.prototype.createEl.call(this, "div")),
          ...
          this.isFullscreen(!0),
            t.requestFullscreen
              ? (z(
                  ue,
                  t.fullscreenchange,
                  cn(this, function e(n) {
                    this.isFullscreen(ue[t.fullscreenElement]),
                      !1 === this.isFullscreen() &&
                        X(ue, t.fullscreenchange, e),
                      this.trigger("fullscreenchange");
                  })
                ),
        ...
        (e.prototype.error = function (t) {
          return void 0 === t
            ...
            : ((this.error_ = new ot(t)),
              this.addClass("vjs-error"),
              Xe.error(
                "(CODE:" +
                  this.error_.code +
                  " " +
                  ot.errorTypes[this.error_.code] +
                  ")",
                this.error_.message,
                this.error_
              ),
  ...
  var uo = {},
    ...
    mo = (function () {
      function t(e) {
        if ((De(this, t), this.constructor === t))
          throw new Error(
      ...
      return (
        ...
        (t.registerPlugin = function (e, n) {
          ...
          else if (lo.prototype.hasOwnProperty(e))
            throw new Error(
              'Illegal plugin name, "' +
                e +
          ...
          return (
            ...
            "plugin" !== e &&
              (t.isBasic(n)
                ? (lo.prototype[e] = yo(e, n))
                : (lo.prototype[e] = go(e, n))),
            n
          );
        }),
  ...
  var _o = function (t, e) {
    ...
    bo = function (t) {
      var e =
        ...
        r = {};
      "object" === (void 0 === e ? "undefined" : Ie(e))
  ...
  if (
    ("undefined" == typeof HTMLVideoElement &&
      h() &&
      (ue.createElement("video"),
      ue.createElement("audio"),
      ue.createElement("track")),
    (te.hooks_ = {}),
    (te.hooks = function (t, e) {
      return (
        (te.hooks_[t] = te.hooks_[t] || []),
    ...
    (te.removeHook = function (t, e) {
      ...
      return (
        !(n <= -1) &&
        ((te.hooks_[t] = te.hooks_[t].slice()), te.hooks_[t].splice(n, 1), !0)
      );
    }),
  ...
  return (
    ...
    (te.addLanguage = function (t, e) {
      ...
      return (
        (t = ("" + t).toLowerCase()),
        (te.options.languages = Z(
          te.options.languages,
          ((n = {}), (n[t] = e), n)
        )),
