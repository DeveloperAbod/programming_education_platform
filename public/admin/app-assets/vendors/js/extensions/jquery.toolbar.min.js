    ...
    var e = {
      ...
      overrideOptions: function () {
        ...
        a.each(b.options, function (a) {
          "undefined" != typeof b.$elem.data("toolbar-" + a) &&
            (b.options[a] = b.$elem.data("toolbar-" + a));
        });
      },
      initializeToolbar: function () {
        ...
        a.populateContent(),
          a.setTrigger(),
          (a.toolbarWidth = a.toolbar.width());
      },
      setTrigger: function () {
        function c() {
        ...
        "click" == d.options.event &&
          (d.$elem.on("click", function (a) {
            a.preventDefault(),
              d.$elem.hasClass("pressed") ? d.hide() : d.show();
          }),
          d.options.hideOnClick &&
            a("html").on("click.toolbar", function (a) {
              a.target != d.elem &&
                0 === d.$elem.has(a.target).length &&
                0 === d.toolbar.has(a.target).length &&
      ...
      populateContent: function () {
        var b = this,
          ...
          d = a(b.options.content).clone(!0).find("a").addClass("tool-item");
        c.html(d),
      ...
      calculatePosition: function () {
        var a = this;
        (a.arrowCss = {}),
          (a.toolbarCss = a.getCoordinates(
            a.options.position,
            a.options.adjustment
          )),
      ...
      getCoordinates: function (a, b) {
        ...
        switch (
          ...
          c.options.adjustment &&
            c.options.adjustment[c.options.position] &&
            (b = c.options.adjustment[c.options.position] + b),
          c.options.position)
        ) {
          case "top":
            return {
      ...
      collisionDetection: function () {
        ...
        ("top" == c.options.position || "bottom" == c.options.position) &&
          ...
          c.toolbarCss.left < d
            ? ((c.toolbarCss.left = d),
              (c.arrowCss.left =
                c.$elem.offset().left + c.$elem.width() / 2 - d))
