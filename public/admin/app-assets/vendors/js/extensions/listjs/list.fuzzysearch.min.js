  ...
  (a.modules = {}),
    ...
    a.register("component-classes/index.js", function (a, b, c) {
      ...
      (c.exports = function (a) {
        ...
        (d.prototype.toggle = function (a) {
          return this.list
            ? (this.list.toggle(a), this)
            : (this.has(a) ? this.remove(a) : this.add(a), this);
        }),
    ...
    a.register("timoxley-is-collection/index.js", function (a, b, c) {
      function d(a) {
        return (
          "object" == typeof a &&
          /^\[object (NodeList)\]$/.test(Object.prototype.toString.call(a)) &&
      ...
      c.exports = function (a) {
        ...
        var c,
          ...
          i = {
            search: function (b, d) {
              for (
                var e = a.multiSearch ? b.replace(/ +$/, "").split(/ +/) : [b],
                  f = 0,
                  g = c.items.length;
                g > f;
                f++
              )
                i.item(c.items[f], d, e);
            },
            item: function (a, b, c) {
              for (var d = !0, e = 0; e < c.length; e++) {
                for (var f = !1, g = 0, h = b.length; h > g; g++)
                  i.values(a.values(), b[g], c[e]) && (f = !0);
                f || (d = !1);
              }
              a.found = d;
            },
        ...
        return {
          init: function (b) {
            (c = b),
              d.bind(g(c.listContainer, a.searchClass), "keyup", function (a) {
    ...
    a.register("list.fuzzysearch.js/src/fuzzy.js", function (a, b, c) {
      c.exports = function (a, b, c) {
        ...
        -1 != k &&
          ((j = Math.min(d(0, k), j)),
          (k = a.lastIndexOf(b, h + b.length)),
          -1 != k && (j = Math.min(d(0, k), j)));
        var l = 1 << (b.length - 1);
        k = -1;
        for (var m, n, o, p = b.length + a.length, q = 0; q < b.length; q++) {
          for (m = 0, n = p; n > m; )
            d(q, h + n) <= j ? (m = n) : (p = n),
              (n = Math.floor((p - m) / 2 + m));
          p = n;
    ...
    a.alias("list.fuzzysearch.js/index.js", "list.fuzzysearch.js/index.js"),
    "object" == typeof exports
      ? (module.exports = a("list.fuzzysearch.js"))
