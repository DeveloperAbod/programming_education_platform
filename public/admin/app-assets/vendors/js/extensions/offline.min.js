...
(function () {
  ...
  (d = function (a, b) {
    ...
    (a.state = "up"),
    (a.markUp = function () {
      if ((a.trigger("confirmed-up"), "up" !== a.state))
        return (a.state = "up"), a.trigger("up");
    }),
    (a.markDown = function () {
      if ((a.trigger("confirmed-down"), "down" !== a.state))
        return (a.state = "down"), a.trigger("down");
    }),
    (f = {}),
    (a.on = function (b, c, d) {
      var e, g, h, i, j;
        ...
        if (b) {
          for (d = 0, g = []; d < f[a].length; )
            (e = f[a][d]),
              e[0],
              (c = e[1]),
              c === b ? g.push(f[a].splice(d, 1)) : g.push(d++);
          return g;
        }
        return (f[a] = []);
      }
    ...
    (a.checks.xhr = function () {
      ...
      (c = new XMLHttpRequest()),
        ...
        null != c.timeout && (c.timeout = a.getOption("checks.xhr.timeout")),
        b(c, a.markUp, a.markDown);
      try {
        c.send();
      } catch (d) {
        d, a.markDown();
    ...
    (g = function () {
      if (
        (a.getOption("interceptRequests") &&
          a.onXHR(function (c) {
            var d;
            if (((d = c.xhr), !1 !== d.offline))
              return b(d, a.markUp, a.confirmDown);
          }),
        a.getOption("checkOnLoad"))
      )
        return a.check();
    }),
    setTimeout(g, 0),
  ...
  function () {
    ...
    for (d = ["up", "down"], b = 0, c = d.length; b < c; b++) {
      ...
      try {
        e =
          document.querySelector("script[data-simulate='" + f + "']") ||
    ...
    e &&
      ...
      (Offline.options.checks.active = f));
  }.call(this),
  function () {
