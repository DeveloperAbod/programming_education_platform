!(function (t, e) {
  ...
  function r(t) {
    ...
    for (e = 0; e < r.length; e++) (s /= 60), (i += a(r.charCodeAt(e)) * s);
    return i * f;
  }
  function l(t) {
  ...
  function v(t, e) {
    for (var n, o; (o = 6e4 * (((e.at - t.at) / 12e4) | 0)); )
      (n = new d(new Date(t.at + o))).offset === t.offset ? (t = n) : (e = n);
    return t;
  }
  function b(t, e) {
  ...
  function g(t, e) {
    var n, o;
    for (l(e), n = 0; n < e.length; n++)
      (o = e[n]), (c[o] = c[o] || {}), (c[o][t] = !0);
  }
  function _() {
    try {
    ...
    var n,
      ...
      s = (function () {
        var t,
          ...
          r = new d(new Date(o, 0, 1)),
          s = [r];
        for (n = 1; n < 48; n++)
          (e = new d(new Date(o, n, 1))).offset !== r.offset &&
            ((t = v(r, e)), s.push(t), s.push(new d(new Date(t.at + 6e4)))),
            (r = e);
        for (n = 0; n < 4; n++)
          s.push(new d(new Date(o + n, 0, 1))),
            s.push(new d(new Date(o + n, 6, 1)));
        return s;
      })(),
      i = s.length,
      f = (function (t) {
        ...
        for (e in s) s.hasOwnProperty(e) && i.push(u[e]);
        return i;
      })(s),
      a = [];
    for (o = 0; o < f.length; o++) {
      for (n = new z(O(f[o]), i), r = 0; r < i; r++) n.scoreOffsetAt(s[r]);
      a.push(n);
    }
  ...
  function O(t, e) {
    ...
    return o instanceof p
      ...
      ? ((o = new p(o)), (i[t] = o))
      : f[t] && e !== O && (n = O(f[t], O))
      ? ((o = i[t] = new p())._set(n), (o.name = u[t]), o)
      : null;
  }
  function S(t) {
    var e, n, o, r;
  ...
  function j(t) {
    ...
    return (
      o && !s.isMoment(t) && M(r) && r.add(o.parse(r), "minutes"), r.tz(n), r
    );
  }
  (n < 2 || (2 == n && o < 6)) &&
    A(
    ...
    (p.prototype = {
      ...
      parse: function (t) {
        ...
        for (r = 0; r < a; r++)
          if (
            ...
            (n = i[r + 1]),
            (o = i[r ? r - 1 : r]),
            e < n && j.moveAmbiguousForward
              ? (e = n)
              : o < e && j.moveInvalidForward && (e = o),
            s < f[r] - 6e4 * e)
          )
            return i[r];
        return i[a];
      ...
      offset: function (t) {
        return (
          A("zone.offset has been deprecated in favor of zone.utcOffset"),
    ...
    (z.prototype.scoreOffsetAt = function (t) {
    ...
    (j.link = S),
    (j.load = function (t) {
      y(t.zones), S(t.links), (j.dataVersion = t.version);
    }),
    (j.zone = O),
  ...
  (s.tz = j),
      ...
      if (
        (void 0 === t._z &&
          (o &&
            M(t) &&
            !t._isUTC &&
            ((t._d = s.utc(t._a)._d), t.utc().add(o.parse(t), "minutes")),
          (t._z = o)),
        t._z)
      )
        if (
    ...
    (D.zoneName = x(D.zoneName)),
    (D.zoneAbbr = x(D.zoneAbbr)),
    (D.utc = Z(D.utc)),
    (D.local = Z(D.local)),
    (D.utcOffset =
      ((T = D.utcOffset),
      function () {
        return (
          0 < arguments.length && (this._z = null), T.apply(this, arguments)
        );
      })),
