(function () {
      ...
      var r = e("../lib/event"),
        ...
        m = function (e, t) {
          ...
          r.addListener(n, "blur", function (e) {
            ...
            (this.$focusScroll = !1),
            (this.focus = function () {
              if (w || l || this.$focusScroll == "browser")
          ...
          var L = d
            ? function (e) {
                ...
                (T != i || N != s) && n.setSelectionRange(i, s),
                  (T = i),
                  (N = s);
              }
            : function () {
                ...
                u.length > c &&
                  (s < c && o < c
                    ...
                    : ((u = "\n"), (s = 0), (o = 1)));
                var l = u + "\n\n";
                l != x && ((n.value = x = l), (T = N = l.length)),
                  _ && ((T = n.selectionStart), (N = n.selectionEnd));
                if (N != o || T != s || n.selectionEnd != N)
                  try {
          ...
          r.addCommandKeyListener(n, t.onCommandKey.bind(t)),
            r.addListener(n, "select", O),
            r.addListener(n, "input", P),
            r.addListener(n, "cut", j),
            r.addListener(n, "copy", F),
            r.addListener(n, "paste", I),
          ...
          var q = function (e) {
              ...
              (r.end.row = r.start.row),
                ...
                y.useTextareaForIME
                  ? ((n.value = ""), (x = ""), (T = 0), (N = 0))
                  : (n.msGetInputContext && (y.context = n.msGetInputContext()),
                    n.getInputContext && (y.context = n.getInputContext()));
            },
            R = function () {
              ...
              if (y.useTextareaForIME) t.onCompositionUpdate(n.value);
                ...
                D(e),
                  y.markerRange &&
                    (y.context &&
                      (y.markerRange.start.column = y.selectionStart =
                        y.context.compositionStartOffset),
                    (y.markerRange.end.column =
                      y.markerRange.start.column + N - y.selectionStart));
              }
            },
            U = function (e) {
          ...
          r.addListener(n, "compositionstart", q),
            r.addListener(n, "compositionupdate", R),
            r.addListener(n, "keyup", X),
            r.addListener(n, "keydown", W),
            r.addListener(n, "compositionend", U),
            ...
            (this.moveToMouse = function (e, o) {
              w || (w = n.style.cssText),
                (n.style.cssText =
                  ...
                  (i.isIE ? "opacity:0.1;" : "") +
                  "text-indent: -" +
                  (T + N) * t.renderer.characterWidth * 0.5 +
                  "px;");
              ...
              (t.renderer.$isMousePressed = !0),
                clearTimeout(V),
                i.isWin && r.capture(t.container, h, $);
            }),
          ...
          r.addListener(n, "mouseup", J),
            r.addListener(n, "mousedown", function (e) {
              e.preventDefault(), $();
            }),
            r.addListener(t.renderer.scroller, "contextmenu", J),
            r.addListener(n, "contextmenu", J),
            d && K(e, t, n);
        };
      t.TextInput = m;
    }
  ...
  define(
    ...
    ["require", "exports", "module", "ace/mouse/mouse_event", "ace/lib/dom"],
    function (e, t, n) {
      "use strict";
      ...
      t.addTouchListeners = function (e, t) {
        ...
        function E() {
          ...
          if (e.isEmpty() || !r)
            t.selection.moveToPosition(h), t.selection.selectWord();
          (n = "wait"), b();
        }
        function S() {
          ...
          var e =
            p >= 2
              ? t.selection.getLineRange(h.row)
              : t.session.getBracketRange(h);
          e && !e.isEmpty()
        ...
        function x() {
          (c += 60),
            (l = setInterval(function () {
              c-- <= 0 && (clearInterval(l), (l = null)),
                Math.abs(d) < 0.01 && (d = 0),
                Math.abs(v) < 0.01 && (v = 0),
                c < 20 && (d = 0.9 * d),
                c < 20 && (v = 0.9 * v);
              var e = t.session.getScrollTop();
              t.renderer.scrollBy(10 * d, 10 * v),
                e == t.session.getScrollTop() && (c = 0);
            }, 10));
        }
        var n = "scroll",
          s,
        ...
        e.addEventListener("contextmenu", function (e) {
          ...
          e.addEventListener("touchstart", function (e) {
            ...
            var b = i[0],
              w = b.clientX,
              x = b.clientY;
            Math.abs(s - w) + Math.abs(o - x) > l && (u = -1),
              (s = e.clientX = w),
              (o = e.clientY = x),
              (d = v = 0);
            var T = new r(e, t);
            h = T.getDocumentPosition();
            if (y - u < 500 && i.length == 1 && !c)
              p++, e.preventDefault(), (e.button = 0), S();
            else {
              p = 0;
          ...
          e.addEventListener("touchend", function (e) {
            (m = t.$mouseHandler.isMousePressed = !1),
              ...
              n == "zoom"
                ? ((n = ""), (c = 0))
                : f
                ? (t.selection.moveToPosition(h), (c = 0), b())
                : n == "scroll"
                ? (x(), e.preventDefault(), w())
                : b(),
              clearTimeout(f),
              (f = null);
          }),
              ...
              if (l) {
                ...
                (g.style.width = i.config.characterWidth * 2 + "px"),
                  (g.className = i.showInvisibles
                    ...
                    : "ace_cjk"),
                  (g.textContent = i.showInvisibles ? i.SPACE_CHAR : p),
                  u.appendChild(g);
              } else if (d) {
                t += 1;
                var g = this.dom.createElement("span");
