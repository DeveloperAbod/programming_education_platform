    ...
    (function () {
      (this.attach = function (e) {
        ...
        (this.onChange = function (e) {
          var t = e.action[0] == "r",
            n = (this.selectedTabstop && this.selectedTabstop.parents) || {},
            r = (this.tabstops || []).slice();
          for (var i = 0; i < r.length; i++) {
            var s = r[i],
              o = s == this.selectedTabstop || n[s.index];
            s.rangeList.$bias = o ? 0 : 1;
            if (e.action == "remove" && s !== this.selectedTabstop) {
              var u = s.parents && s.parents[this.selectedTabstop.index],
                a = s.rangeList.pointIndex(e.start, u);
              a = a < 0 ? -a - 1 : a + 1;
