  ...
  return /******/ (function (modules) {
    ...
    /******/ {
      ...
      /***/ 3: /***/ function (
        ...
        external_jQuery_default.a.summernote = external_jQuery_default.a
          .summernote || {
          lang: {},
        };
        external_jQuery_default.a.extend(
          external_jQuery_default.a.summernote.lang,
          {
            "en-US": {
              font: {
                bold: "Bold",
        ...
        function validFontName(fontName) {
          return external_jQuery_default.a.inArray(
        ...
        class Context_Context {
          ...
          _initialize() {
            ...
            const buttons = external_jQuery_default.a.extend(
              {},
            ...
            const modules = external_jQuery_default.a.extend(
              {},
              this.options.modules,
              external_jQuery_default.a.summernote.plugins || {}
        ...
        external_jQuery_default.a.fn.extend({
          ...
          summernote: function () {
            ...
            const options = external_jQuery_default.a.extend(
              {},
              external_jQuery_default.a.summernote.options,
              hasInitOptions ? lists.head(arguments) : {}
            ); // Update options

            options.langInfo = external_jQuery_default.a.extend(
              true,
              {},
              external_jQuery_default.a.summernote.lang["en-US"],
              external_jQuery_default.a.summernote.lang[options.lang]
            );
            options.icons = external_jQuery_default.a.extend(
              true,
              {},
              external_jQuery_default.a.summernote.options.icons,
              options.icons
            );
            options.tooltip =
        ...
        function readFileAsDataURL(file) {
          return external_jQuery_default.a
            .Deferred((deferred) => {
        ...
        class Style_Style {
          ...
          current(rng) {
            const $cont = external_jQuery_default()(
          ...
          toggleList(listName, editable) {
            ...
            if (lists.find(paras, dom.isPurePara)) {
              ...
              const diffLists = rng
                ...
                .filter((listNode) => {
                  return !external_jQuery_default.a.nodeName(
                    listNode,
                    listName
                  );
                });
        ...
        class Table_Table {
          ...
          addRow(rng, position) {
            ...
            const html = external_jQuery_default()(
              "<tr" + trAttributes + "></tr>"
            );
              ...
              switch (currentCell.action) {
                ...
                case TableResultAction.resultAction.SumSpanCount:
                  if (position === "top") {
                    ...
                    if (isTopFromRowSpan) {
                      const newTd = external_jQuery_default()("<div></div>")
                        .append(
          ...
          createTable(colCount, rowCount, options) {
            ...
            trHTML = trs.join("");
            const $table = external_jQuery_default()(
              "<table>" + trHTML + "</table>"
            );
        ...
        class Editor_Editor {
          constructor(context) {
            ...
            this.insertNode = this.wrapCommand((node) => {
              if (
                this.isLimited(external_jQuery_default()(node).text().length)
              ) {
                return;
              }
            ...
            this.createLink = this.wrapCommand((linkInfo) => {
              ...
              const startRange = range.createFromNodeBefore(
                lists.head(anchors)
              );
            ...
            this.removeMedia = this.wrapCommand(() => {
              let $target = external_jQuery_default()(
                this.restoreTarget()
              ).parent();
            ...
            if ($target && $target.length) {
              ...
              if ($target && $target.length) {
                ...
                if (className) {
                  ...
                  const $parent = external_jQuery_default()([
                    currentRange.sc,
                    currentRange.ec,
                  ]).closest(tagName);
          ...
          getLinkInfo() {
            ...
            const $anchor = external_jQuery_default()(
        ...
        class AutoLink_AutoLink {
          ...
          replace() {
            ...
            if (match && (match[1] || match[2])) {
              ...
              const node = external_jQuery_default()("<a />")
                .html(keyword)
                .attr("href", link)[0];
        ...
        class Buttons_Buttons {
              ...
              .buttonGroup({
                ...
                children: [
                  this.button({
                    ...
                    tooltip: tooltip,
                    click: (e) => {
                      const $button = external_jQuery_default()(
                        e.currentTarget
                      );
                  ...
                  this.ui.dropdown({
                      ...
                      $dropdown.find("input[type=color]").each((idx, item) => {
                        external_jQuery_default()(item).change(function () {
                          const $chip = $dropdown
                            .find(
                              "#" +
                                external_jQuery_default()(this).data("event")
                            )
                            .find(".note-color-btn")
                            .first();
                    ...
                    click: (event) => {
                      ...
                      if (eventName === "openPalette") {
                        ...
                        const $palette = external_jQuery_default()(
                          $parent
          ...
          addToolbarButtons() {
            ...
            this.context.memo("button.bold", () => {
              return this.button({
                ...
                click:
                  this.context.createInvokeHandlerAndUpdateState("editor.bold"),
              }).render();
            });
            this.context.memo("button.italic", () => {
              return this.button({
                ...
                tooltip:
                  this.lang.font.italic + this.representShortcut("italic"),
                click:
                  this.context.createInvokeHandlerAndUpdateState(
                    "editor.italic"
                  ),
              }).render();
            });
            ...
            this.context.memo("button.hr", () => {
              return this.button({
                ...
                tooltip:
                  this.lang.hr.insert +
                  this.representShortcut("insertHorizontalRule"),
                click: this.context.createInvokeHandler(
          ...
          tableMoveHandler(event) {
            ...
            if (event.offsetX === undefined) {
              const posCatcher = external_jQuery_default()(
                event.target
              ).offset();
              posOffset = {
          ...
          createShortcutList() {
            ...
            return Object.keys(keyMap)
              .map((key) => {
                ...
                const $row = external_jQuery_default()(
                ...
                $row
                  ...
                  .append(
                    external_jQuery_default()("<span/>").html(
          ...
          constructor(context) {
            ...
            this.events = {
              ...
              "summernote.focusout": (we, e) => {
                ...
                if (
                  !e.relatedTarget ||
                  !dom.ancestor(e.relatedTarget, func.eq(this.$popover[0]))
                ) {
                  this.hide();
                }
              },
        ...
        class HintPopover_HintPopover {
          ...
          createItemTemplates(hintIdx, items) {
            ...
            return items.map((item, idx) => {
              const $item = external_jQuery_default()(
          ...
          createGroup(idx, keyword) {
            const $group = external_jQuery_default()(
        ...
        external_jQuery_default.a.summernote = external_jQuery_default.a.extend(
          external_jQuery_default.a.summernote,
          {
            version: "0.8.12",
            plugins: {},
            dom: dom,
      ...
      /***/ 51: /***/ function (
        ...
        const dropdown = renderer["a" /* default */].create(
          '<ul class="note-dropdown-menu dropdown-menu" role="list">',
        ...
        const dropdownCheck = renderer["a" /* default */].create(
          '<ul class="note-dropdown-menu dropdown-menu note-check" role="list">',
          function ($node, options) {
            const markup = Array.isArray(options.items)
              ? options.items
                  .map(function (item) {
