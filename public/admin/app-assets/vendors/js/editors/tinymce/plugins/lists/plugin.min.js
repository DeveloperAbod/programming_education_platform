...
!(function (r) {
  ...
  function S(e) {
    return 0 === e.length ? Ve.none() : Ve.some(e[0]);
  }
  function O(e) {
    return 0 === e.length ? Ve.none() : Ve.some(e[e.length - 1]);
  }
  function C(e, n, t) {
  ...
  function A(e, n, t) {
    return e.isSome() && n.isSome()
      ? Ve.some(t(e.getOrDie(), n.getOrDie()))
      : Ve.none();
  }
  function x(e) {
    return Ve.from(e.dom().parentNode).map(En.fromDom);
  }
  function R(e) {
    return g(e.dom().childNodes, En.fromDom);
  }
  function I(e, n) {
    var t = e.dom().childNodes;
    return Ve.from(t[n]).map(En.fromDom);
  }
  function _(e) {
    return I(e, 0);
  }
  ...
  function H(e, n) {
    return (function (e, n) {
      for (
        var t = n !== undefined && null !== n ? n : Bn, r = 0;
  ...
  function q(e) {
    ...
    return e.dom.getParent(n, "OL,UL,DL", Zn(e, n));
  }
  function W(e) {
    var n = e.selection.getSelectedBlocks();
    return Fn.grep(
      (function (t, e) {
        var n = Fn.map(e, function (e) {
          var n = t.dom.getParent(e, "li,dd,dt", Zn(t, e));
          return n || e;
        });
        return Un.unique(n);
      })(e, n),
  ...
  function V(e, n) {
    var t = e.dom.getParents(n, "ol,ul", Zn(e, n));
    return O(t);
  }
  function z(e, n) {
    var t,
    ...
    if (
      ...
      o &&
        ...
        Qn(n.firstChild, s) || a.appendChild(r)),
      n)
    )
      for (; (t = n.firstChild); ) {
        var c = t.nodeName;
  ...
  function X(e, n) {
    var t = e.dom();
    !(function (e, n) {
      for (var t = _n(e), r = 0, o = t.length; r < o; r++) {
        var i = t[r];
        n(e[i], i);
      }
    })(n, function (e, n) {
  ...
  function Y(e, n, t) {
    ...
    !(function (e) {
      return e.style !== undefined && Qe(e.style.getPropertyValue);
    })(e) || e.style.setProperty(n, t);
  }
  function G(e) {
    return (function (e, n) {
      return En.fromDom(e.dom().cloneNode(n));
    })(e, !0);
  }
  function J(e, n) {
    var t = (function (e, n) {
    ...
    var r = (function (e, n, t) {
      for (var r, o, i, u = [], s = 0; s < t; s++)
        u.push(
          ...
          (o = n.listType),
          void 0,
          (i = { list: En.fromTag(o, r), item: En.fromTag("li", r) }),
          M(i.list, i.item),
          i)
        );
      return u;
    ...
    p(t, function (n, e) {
      (function (e, n) {
        for (var t = e[n].depth, r = n - 1; 0 <= r; r--) {
          if (e[r].depth === t) return Ve.some(e[r]);
        ...
        !(function (e, n) {
          (e.listType = n.listType),
            (e.listAttributes = it({}, n.listAttributes));
        })(n, e);
      });
    });
  }
  ...
  function de(e) {
    var n = g(nt.getSelectedListItems(e), En.fromDom);
    return A(
      y(n, t(re)),
      y(
        (function (e) {
  ...
  function le(t, e, r) {
    var n = (function (e, n) {
      var t = ut(!1);
      return g(e, function (e) {
        return { sourceList: e, entries: st(0, n, t, e) };
      });
    })(e, de(t));
    p(n, function (e) {
      !(function (e, n) {
  ...
  function pe(e, n) {
    if (jn(e)) return { container: e, offset: n };
    var t = xn.getNode(e, n);
    return jn(t)
      ? { container: t, offset: n >= e.childNodes.length ? t.data.length : 0 }
      : t.previousSibling && jn(t.previousSibling)
      ? { container: t.previousSibling, offset: t.previousSibling.data.length }
      : t.nextSibling && jn(t.nextSibling)
      ? { container: t.nextSibling, offset: 0 }
      : { container: e, offset: n };
  }
  function ve(e, n) {
    var t = g(nt.getSelectedListRoots(e), En.fromDom),
      r = g(nt.getSelectedDlItems(e), En.fromDom),
      o = !1;
    if (t.length || r.length) {
      ...
      le(e, t, n),
        ...
        e.selection.setRng(dt(e.selection.getRng())),
        e.nodeChanged(),
        (o = !0);
    }
    return o;
    ...
    !(function (e, n, t) {
      ...
      (function (e, n, t) {
        Ce(n, t["list-attributes"]),
          Fn.each(e.select("li", n), function (e) {
  ...
  function Le(e, n, t, r) {
    ...
    for (
      o = n[t ? "startContainer" : "endContainer"],
        ...
        !t && zn(o.nextSibling) && (o = o.nextSibling);
      o.parentNode !== r;
  ...
  function Te(r, o, i) {
    ...
    var e,
      ...
      u = "LI",
      t = nt.getClosestListRootElm(r, r.selection.getStart(!0)),
      s = r.dom;
    "false" !== s.getContentEditable(r.selection.getNode()) &&
      ...
      Fn.each(
        (function (t, e, r) {
          ...
          return (
            Fn.each(a, function (e) {
              if (Xn(t, e)) return i.push(e), void (o = null);
              if (u.isBlock(e) || zn(e))
                return zn(e) && u.remove(e), void (o = null);
              var n = e.nextSibling;
              lt.isBookmarkNode(e) && (Xn(t, n) || (!n && e.parentNode === r))
                ? (o = null)
                : (o ||
                    ((o = u.create("p")),
      ...
      r.selection.setRng(pt(e)));
  }
  function Ee(e, n, t) {
    return (
      (function (e, n) {
        return e && n && Hn(e) && e.nodeName === n.nodeName;
      })(n, t) &&
      (function (e, n, t) {
        return (
  ...
  function De(n, e, t, r, o) {
    if (e.nodeName !== r || ht(o)) {
      var i = gt(n.selection.getRng(!0));
      Fn.each([e].concat(t), function (e) {
        !(function (e, n, t, r) {
          if (n.nodeName !== t) {
  ...
  function we(e, n) {
    ...
    "LI" === r.nodeName &&
      ...
      ((t = r.previousSibling) && "LI" === t.nodeName
        ? (t.appendChild(n), Gn(e, r) && Nt.remove(r))
  ...
  function ke(e, n, t, r) {
    var o = n.startContainer,
      i = n.startOffset;
    if (jn(o) && (t ? i < o.data.length : 0 < i)) return o;
    var u = e.schema.getNonEmptyElements();
    1 === o.nodeType && (o = xn.getNode(o, i));
    var s = new Rn(o, r);
    for (t && Yn(e.dom, o) && s.next(); (o = s[t ? "next" : "prev2"]()); ) {
      if ("LI" === o.nodeName && !o.hasChildNodes()) return o;
      if (u[o.nodeName]) return o;
      if (jn(o) && 0 < o.data.length) return o;
    }
  }
  function Ae(e, n) {
    var t = n.childNodes;
    return 1 === t.length && !Hn(t[0]) && e.isBlock(t[0]);
  }
  function xe(e, n, t) {
    var r, o;
    if (
  ...
  function Re(n, e, t) {
    var r,
      ...
      i = e.parentNode;
    if (Jn(n, e) && Jn(n, t)) {
      Hn(t.lastChild) && (o = t.lastChild),
        i === t.lastChild &&
          zn(i.previousSibling) &&
          n.remove(i.previousSibling),
        (r = t.lastChild) && zn(r) && e.hasChildNodes() && n.remove(r),
        Gn(n, t, !0) && n.$(t).empty(),
        xe(n, e, t),
        o && t.appendChild(o);
      var u = kn(En.fromDom(t), En.fromDom(e)) ? n.getParents(e, Hn, t) : [];
      n.remove(e),
        p(u, function (e) {
          Gn(n, e) && e !== n.getRoot() && n.remove(e);
        });
    }
  }
  function Ie(e, n, t, r) {
    ...
    if (o.isEmpty(r))
      ...
      var i = gt(n);
      Re(o, t, r), e.selection.setRng(pt(i));
    }
  }
  function _e(e, n) {
    var t = e.dom,
      r = e.selection,
      o = r.getStart(),
      i = nt.getClosestListRootElm(e, o),
      u = t.getParent(r.getStart(), "LI", i);
    if (u) {
      var s = u.parentNode;
      if (s === e.getBody() && Gn(t, s)) return !0;
      var a = dt(r.getRng()),
    ...
    return (
      ...
      (function (e, n) {
        var t = e.dom,
          ...
          o = nt.getClosestListRootElm(e, r),
          i = t.getParent(r, t.isBlock, o);
        if (i && t.isEmpty(i)) {
          var u = dt(e.selection.getRng()),
            ...
            return (
              e.undoManager.transact(function () {
                !(function (e, n, t) {
                  ...
                  yt.mergeWithAdjacentLists(t, s.parentNode),
    ...
    return e.selection.isCollapsed()
      ...
      : (function (e) {
          var n = e.selection.getStart(),
            t = nt.getClosestListRootElm(e, n);
          return (
            !!(
              e.dom.getParent(n, "LI,DT,DD", t) ||
              0 < nt.getSelectedListItems(e).length
            ) &&
            (e.undoManager.transact(function () {
              e.execCommand("Delete"), St(e.dom, e.getBody());
            }),
            !0)
          );
        })(e);
  ...
  var Fe,
    ...
    Ve = {
      ...
      none: n,
      from: function (e) {
        return null === e || e === undefined ? a : We(e);
      },
    },
    ze = m("string"),
    Ke = m("array"),
    ...
    fn = {
      unknown: function () {
        return cn({ current: undefined, version: tn.unknown() });
      },
      nu: cn,
      edge: d(rn),
      chrome: d(on),
    ...
    vn = {
      unknown: function () {
        return pn({ current: undefined, version: tn.unknown() });
      },
      nu: pn,
      windows: d(dn),
      ios: d("iOS"),
    ...
    Cn = { browsers: d(Sn), oses: d(On) },
    bn = function (e) {
      var n = Cn.browsers(),
        t = Cn.oses(),
        r = hn(n, e).fold(fn.unknown, fn.nu),
        o = yn(t, e).fold(vn.unknown, vn.nu);
      return {
        browser: r,
        os: o,
      ...
      detect:
        ...
        function () {
          for (var e = [], n = 0; n < arguments.length; n++)
            e[n] = arguments[n];
          return He || ((He = !0), (je = Fe.apply(null, e))), je;
        }),
    },
    Tn = function (e) {
    ...
    En = {
      ...
      fromPoint: function (e, n, t) {
        var r = e.dom();
        return Ve.from(r.elementFromPoint(n, t)).map(Tn);
      },
    },
    Dn =
    ...
    wn =
      ...
      Dn),
    kn = Ln.detect().browser.isIE()
      ? function (e, n) {
          return Ze(e.dom(), n.dom());
        }
      : function (e, n) {
          var t = e.dom(),
            r = n.dom();
    ...
    xn = tinymce.util.Tools.resolve("tinymce.dom.RangeUtils"),
    Rn = tinymce.util.Tools.resolve("tinymce.dom.TreeWalker"),
    ...
    nt = {
      ...
      getSelectedSubLists: function (e) {
        ...
        return (function (e, n) {
          ...
          ? (function (e) {
              return Fn.grep(e.querySelectorAll("ol,ul,dl"), function (e) {
                return Hn(e);
              });
            })(n)
          : Fn.grep(t, function (e) {
              return Hn(e) && n !== e;
            });
      },
      getSelectedListItems: W,
      getClosestListRootElm: Zn,
      ...
      getSelectedListRoots: function (e) {
        var n = (function (e) {
          var n = V(e, e.selection.getStart()),
            t = v(e.selection.getSelectedBlocks(), $n);
          return n.toArray().concat(t);
        })(e);
        return et(e, n);
      },
    },
    tt = tinymce.util.Tools.resolve("tinymce.Env"),
    rt =
      (($e = Dn),
      function (e) {
        return (
    ...
    it =
      ...
      function () {
        ...
        for (var t = {}, r = 0; r < e.length; r++) {
          var o = e[r];
          for (var i in o) ot.call(o, i) && (t[i] = qe(t[i], o[i]));
        }
        return t;
      }),
    ut = function (e) {
    ...
    ft = function (e, n, t) {
      var r, o, i, u, s, a;
      for (
        i = ct.select('span[data-mce-type="bookmark"]', n),
          s = z(e, t),
          (r = ct.createRng()).setStartAfter(t),
          r.setEndAfter(n),
      ...
      e.dom.isEmpty(o) || ct.insertAfter(o, n),
        ct.insertAfter(s, n),
        Gn(e.dom, t.parentNode) &&
          ((a = t.parentNode),
          Fn.each(i, function (e) {
            a.parentNode.insertBefore(e, t.parentNode);
          }),
          ct.remove(a)),
        ct.remove(t),
        Gn(e.dom, n) && ct.remove(n);
    },
    dt = function (e) {
      var n = e.cloneRange(),
    ...
    lt = tinymce.util.Tools.resolve("tinymce.dom.BookmarkManager"),
    mt = at.DOM,
    gt = function (o) {
      function e(e) {
        var n, t, r;
        (t = o[e ? "startContainer" : "endContainer"]),
          ...
          1 === t.nodeType &&
            ((n = mt.create("span", { "data-mce-type": "bookmark" })),
            t.hasChildNodes()
              ? ((r = Math.min(r, t.childNodes.length - 1)),
                e
                  ? t.insertBefore(n, t.childNodes[r])
                  : mt.insertAfter(n, t.childNodes[r]))
              : t.appendChild(n),
            (t = n),
            (r = 0)),
    ...
    vt = function (e, n) {
      var t, r;
      if (((t = n.nextSibling), Ee(e, n, t))) {
        for (; (r = t.firstChild); ) n.appendChild(r);
        e.remove(t);
      }
      if (((t = n.previousSibling), Ee(e, n, t))) {
    ...
    yt = {
      toggleList: function (e, n, t) {
        var r = nt.getParentList(e),
          o = nt.getSelectedSubLists(e);
        (t = t || {}),
          r && 0 < o.length
            ? De(e, r, o, n, t)
            : (function (e, n, t, r) {
                if (n !== e.getBody())
                  if (n)
                    if (n.nodeName !== t || ht(r) || Se(n)) {
                      var o = gt(e.selection.getRng(!0));
                      be(e.dom, n, r);
                      var i = e.dom.rename(n, t);
                      vt(e.dom, i), e.selection.setRng(pt(o)), j(e, Oe(t), i);
                    } else Ne(e);
                  else Te(e, t, r), j(e, Oe(t), n);
              })(e, r, n, t);
      },
      mergeWithAdjacentLists: vt,
    },
    Nt = at.DOM,
    St = function (n, e) {
      Fn.each(Fn.grep(n.select("ol,ul", e)), function (e) {
        we(n, e);
      });
    },
    Ot = function (n) {
      n.on("keydown", function (e) {
        e.keyCode === In.BACKSPACE
          ? Pe(n, !1) && e.preventDefault()
          : e.keyCode === In.DELETE && Pe(n, !0) && e.preventDefault();
      });
    },
    Ct = Pe,
    bt = function (n) {
          ...
          n.on("keydown", function (e) {
            e.keyCode !== In.TAB ||
              ...
              n.undoManager.transact(function () {
                (e.shiftKey ? ye(n) : he(n)) && e.preventDefault();
              });
          });
        })(e),
        Ot(e);
