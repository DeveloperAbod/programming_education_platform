...
!(function (c) {
  ...
  function D(n, t) {
    return (
      ...
      nn(t) ? n.dom.select("a[href]", t)[0] : n.dom.getParent(t, "a[href]")
    );
  }
  function U(n) {
  ...
  var V,
    ...
    J = {
      ...
      none: t,
      from: function (n) {
        return null === n || n === undefined ? C : G(n);
      },
    },
    ...
    rn = function (o, i, u) {
      o.undoManager.transact(function () {
        var n = o.selection.getNode(),
          t = D(o, n),
          e = M(u);
        if (!(0 < v(o).length) && !1 === k(o)) {
          var r = R(e.rel, "_blank" === e.target);
          e.rel = r || null;
        }
        J.from(e.target).isNone() && (e.target = p(o)),
          (e.href = (function (n, t) {
            return ("http" !== t && "https" !== t) || L(n) ? n : t + "://" + n;
          })(e.href, d(o))),
      ...
      return {
        onChange: function (n, t) {
          return "url" === t.name
            ...
            : I(["anchor", "link"], t.name)
            ? e(n(), t)
            : ("text" === t.name && o.set(n().text), J.none());
        },
      };
    },
    gn = function () {
  ...
  function _n(n) {
    return bn(n, n.selection.getStart());
  }
  function Tn(n, t) {
    if (t) {
      var e = cn(t);
  ...
  var On = yn.exports.boltExport,
    ...
    In = tinymce.util.Tools.resolve("tinymce.util.Delay"),
    Sn = function (n, t, r) {
      return z(
        [
          kn,
        ...
        function (e) {
          return Nn(function (t) {
            !(function (t, n, e) {
              ...
              In.setEditorTimeout(t, function () {
    ...
    Ln = tinymce.util.Tools.resolve("tinymce.util.XHR"),
    Rn = function (t) {
      function e(n) {
    ...
    zn = function (e, r) {
      return Rn(e).map(function (n) {
        var t = (function (n, t) {
          var e = n.dom,
            r = an(n.selection.getContent())
              ...
              body: {
                ...
                items: j([
                  ...
                  (function (n) {
                    ...
                    c.anchor.map(mn.createUi("anchor", "Anchors")),
                    c.rels.map(mn.createUi("rel", "Rel")),
                    c.targets.map(mn.createUi("target", "Open link in...")),
                    c.link.map(mn.createUi("link", "Link list")),
                    c.classes.map(mn.createUi("linkClass", "Class")),
                  ]),
                ]),
              },
              buttons: [
    ...
    Vn = function (e) {
      e.on("click", function (n) {
        var t = bn(e, n.target);
        t && o.metaKeyPressed(n) && (n.preventDefault(), Tn(e, t));
      }),
        ...
        commands: [
          {
            ...
            onSetup: function (n) {
              var t = i.selection.getNode();
              return n.setActive(!!fn(i, t)), Wn(i)(n);
            },
            onAction: function (n) {
              var t = fn(i),
                e = n.getValue();
  ...
  !(function Zn() {
    r.add("link", function (n) {
      Jn(n), Xn(n), Qn(n), Yn(n), Vn(n), $n(n), Gn(n);
    });
  })();
})(window);
