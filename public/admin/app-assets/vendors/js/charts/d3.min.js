!(function () {
  ...
  function j(n) {
    function t() {
      var t = this.ownerDocument,
        e = this.namespaceURI;
      return e === Ca && t.documentElement.namespaceURI === Ca
        ? t.createElement(n)
  ...
  function W(e) {
    ...
    if (
      (null == Ta &&
        (Ta = "onselectstart" in e ? !1 : x(e.style, "userSelect")),
      Ta)
    ) {
      var a = n(e).style,
        o = a[Ta];
  ...
  function pn(n, t, e) {
    return n > 0
      ? new sn(Math.atan2(e, t) * Ya, Math.sqrt(t * t + e * e), n)
      : new sn(NaN, NaN, n);
  }
  function vn(n) {
  ...
  function Sn(n, t, e) {
    ...
    var r = dn((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / Qa),
      u = dn((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / no),
      i = dn((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / to);
  ...
  function qn(n, t, e) {
    ...
    return (
      ao ? (ao.n = i) : (io = i),
      (ao = i),
      oo || ((lo = clearTimeout(lo)), (oo = 1), co(Tn)),
      i
    );
  }
  function Tn() {
    var n = Rn(),
      t = Dn() - n;
    t > 24
      ? (isFinite(t) && (clearTimeout(lo), (lo = setTimeout(Tn, t))), (oo = 0))
      : ((oo = 1), co(Tn));
  }
  function Rn() {
      ...
      var g,
        ...
        y = {
          ...
          polygonEnd: function () {
            ...
            var n = Ot(m, p);
            g.length
              ? (b || (i.polygonStart(), (b = !0)), Lt(g, Ut, n, e, i))
              : n &&
  ...
  function Ut(n, t) {
    return (
      ((n = n.x)[0] < 0 ? n[1] - Oa - Pa : Oa - n[1]) -
      ((t = t.x)[0] < 0 ? t[1] - Oa - Pa : Oa - t[1])
    );
  }
  function jt(n) {
    var t,
      ...
      if (s)
        for (
          ...
          var m = n[0],
            ...
            k = p * M;
          if (
            (ko.add(Math.atan2(k * _ * Math.sin(w), v * x + k * Math.cos(w))),
            (i += S ? b + _ * Fa : b),
            S ^ (h >= e) ^ (m >= e))
          ) {
            var N = yt(dt(f), dt(n));
    ...
    var u = Math.cos(t),
      ...
      p = h
        ? function (n) {
            ...
            return [
              Math.atan2(u, r) * Ya,
              Math.atan2(a, Math.sqrt(r * r + u * u)) * Ya,
            ];
          }
        : function () {
            return [n * Ya, t * Ya];
  ...
  function Se(n, t) {
    ...
    return i
      ? ((e.invert = function (n, t) {
          ...
          return [
            Math.atan2(n, e) / i,
            2 * Math.atan(Math.pow(a / r, 1 / i)) - Oa,
          ];
        }),
        e)
      : Ne;
  ...
  function Fe(n) {
    ...
    for (
      var l = i;
      l.circle && Ma(e - l.circle.x) < Pa && Ma(r - l.circle.cy) < Pa;
    ...
    for (
      var c = a;
      c.circle && Ma(e - c.circle.x) < Pa && Ma(r - c.circle.cy) < Pa;
  ...
  function Be(n) {
    var t = n.circle;
    t &&
      (t.P || (ol = t.N), ll.remove(t), sl.push(t), rr(t), (n.circle = null));
  }
  function We(n) {
    for (
      var t, e = ul, r = Yt(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length;
      u--;
      ...
      (t = e[u]),
        (!Je(t, n) ||
          !r(t) ||
          (Ma(t.a.x - t.b.x) < Pa && Ma(t.a.y - t.b.y) < Pa)) &&
  ...
  function or(n, t) {
    ...
    for (ul = [], il = new Array(n.length), al = new er(), ll = new er(); ; )
      if (((u = ol), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x))))
        (i.x !== e || i.y !== r) &&
          ((il[i.i] = new Ye(i)), He(i), (e = i.x), (r = i.y)),
          (i = n.pop());
      else {
        if (!u) break;
        Fe(u.arc);
  ...
  function yr(n, t) {
    var e,
      ...
      o = [],
      l = [];
    for (n += "", t += ""; (e = hl.exec(n)) && (r = gl.exec(t)); )
      (u = r.index) > i &&
  ...
  function jr(n) {
    ...
    t[0] * e[1] < e[0] * t[1] &&
      ((t[0] *= -1), (t[1] *= -1), (r *= -1), (u *= -1)),
      (this.rotate =
        (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Ya),
  ...
  function Mi(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((a = "function" == typeof n ? (i = n) : (i = Tl.get(n) || xi).key),
            t)
          : a;
      }),
  ...
  function Oi(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((l = "function" == typeof n ? (o = n) : (o = Tl.get(n) || xi).key),
            (c = o.reverse || o),
            (s = o.closed ? "M" : "L"),
            t)
          : l;
  ...
  (oa.ns = {
    ...
    qualify: function (n) {
      ...
      return (
        ...
        za.hasOwnProperty(e) ? { space: za[e], local: n } : n
      );
    },
  }),
  ...
  (oa.interpolateZoom = function (n, t) {
    ...
    (oa.behavior.zoom = function () {
      ...
      function g() {
        ...
        y
          ? clearTimeout(y)
          : (Il.call(this), (v = e((d = m || oa.mouse(this)))), l(n)),
          (y = setTimeout(function () {
            (y = null), s(n);
          }, 50)),
          S(),
          u(Math.pow(2, 0.002 * $a()) * k.k),
          i(d, v),
          c(n);
      }
      function p() {
  ...
  (go.year = On(
    ...
    [
      ...
      var e = (go[n] = On(
        function (n) {
          return (
            (n = go.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)), n
          );
        },
        function (n, t) {
  ...
  (oa.geo.bounds = (function () {
    ...
    (oa.geo.centroid = function (n) {
      ...
      return Ua > u &&
        ...
        (e = To),
        (r = Ro),
        Pa > Ao && ((t = Co), (e = zo), (r = Lo)),
        (u = t * t + e * e + r * r),
        Ua > u)
        ? [NaN, NaN]
        : [Math.atan2(e, t) * Ya, tn(r / Math.sqrt(u)) * Ya];
    });
  var Eo,
    Ao,
    Co,
        ...
        (n.translate = function (t) {
          ...
          return (
            ...
            (r = a
              ...
              .clipExtent([
                [s - 0.425 * c + Pa, f + 0.12 * c + Pa],
                [s - 0.214 * c - Pa, f + 0.234 * c - Pa],
              ])
              .stream(l).point),
            (u = o
              .translate([s - 0.205 * c, f + 0.212 * c])
              .clipExtent([
                [s - 0.214 * c + Pa, f + 0.166 * c + Pa],
                [s - 0.115 * c - Pa, f + 0.234 * c - Pa],
              ])
              .stream(l).point),
            n
          );
  ...
  (oa.geo.path = function () {
    ...
    (oa.geo.rotation = function (n) {
      ...
      return (
        (n = fe((n[0] % 360) * Ia, n[1] * Ia, n.length > 2 ? n[2] * Ia : 0)),
        (t.invert = function (t) {
          return (
  ...
  (oa.interpolate = Mr),
    (oa.interpolators = [
      function (n, t) {
        ...
        return (
          "string" === e
            ? uo.has(t.toLowerCase()) || /^(#|rgb\(|hsl\()/i.test(t)
              ? vr
              : yr
            : t instanceof on
            ? vr
  ...
  oa.layout.stack = function () {
    ...
    return (
      ...
      (n.order = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : _l.get(t) || pu), n)
          : e;
      }),
      (n.offset = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : wl.get(t) || vu), n)
          : r;
      }),
      (n.x = function (t) {
        return arguments.length ? ((i = t), n) : i;
      ...
      function n() {
        ...
        if (
          ((m = (+l.apply(this, arguments) || 0) / 2) &&
            ((d =
              i === ql ? Math.sqrt(n * n + c * c) : +i.apply(this, arguments)),
            g || (E *= -1),
      ...
      return (
        ...
        (n.centroid = function () {
          var n = (+e.apply(this, arguments) + +r.apply(this, arguments)) / 2,
            t =
              (+a.apply(this, arguments) + +o.apply(this, arguments)) / 2 - Oa;
  ...
  (Aa.transition = function (n) {
    for (
      var t,
        ...
        u = Ki(n),
        i = [],
        a = Ol || { time: Date.now(), ease: Nr, delay: 0, duration: 250 },
        o = -1,
        l = this.length;
      ++o < l;
