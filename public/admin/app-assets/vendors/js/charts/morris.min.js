        ...
        if (
          ((this.el = a(
            "string" == typeof b.element
              ? document.getElementById(b.element)
              : b.element
          )),
      ...
      return (
        ...
        (d.prototype.setData = function (c, d) {
          ...
          if (
            ...
            if (this.options.parseTime)
              for (x = this.options.events, v = 0, w = x.length; w > v; v++)
                (e = x[v]),
                  e instanceof Array
                    ? ((g = e[0]),
                      (o = e[1]),
          ...
          return (
            ...
            ((y = this.options.axes) === !0 ||
              ...
              this.options.ymin === this.gridDefaults.ymin
                ...
                : ((n = (this.ymax - this.ymin) / (this.options.numLines - 1)),
                  (this.grid = function () {
                    var a, b, c, d;
                    for (
                      d = [], q = a = b = this.ymin, c = this.ymax;
                      n > 0 ? c >= a : a >= c;
                      q = a += n
                    )
                      d.push(q);
        ...
        (d.prototype._calc = function () {
          ...
          return (
            ...
            ((h = this.options.axes) === !0 || "both" === h || "y" === h) &&
              ((g = function () {
                var a, b, d, e;
            ...
            ((i = this.options.axes) === !0 || "both" === i || "x" === i) &&
              ((a = this.options.horizontal ? -90 : -this.options.xLabelAngle),
              (b = function () {
                var b, c, d;
                for (
      ...
      function d(a) {
        return (
          ...
          this instanceof b.Line
            ? void d.__super__.constructor.call(this, a)
            : new b.Line(a)
        );
      }
      return (
          ...
          return (this.paths = function () {
            ...
            for (
              ...
              (e =
                ...
                j.push(
                  a.length > 1 ? b.Line.createPath(a, e, this.bottom) : null
                );
            return j;
          }.call(this));
        }),
      ...
      function d(c) {
        ...
        return this instanceof b.Area
          ? ((f = a.extend({}, e, c)),
            ...
            void d.__super__.constructor.call(this, f))
          : new b.Area(c);
      }
      var e;
      return (
    ...
    (b.Bar = (function (c) {
      function d(c) {
        return (
          ...
          this instanceof b.Bar
            ? void d.__super__.constructor.call(
                this,
      ...
      return (
        ...
        (d.prototype.drawSeries = function () {
          ...
          if (
            ((c = this.xSize / this.options.data.length), this.options.stacked)
          )
            i = 1;
          else
            for (
          ...
          return (
            (a =
              (c * this.options.barSizeRatio - this.options.barGap * (i - 1)) /
              i),
        ...
        (d.prototype.hitTest = function (a, b) {
          ...
          return 0 === this.data.length
            ...
            : ((c = this.options.horizontal ? b : a),
              ...
              Math.min(
                this.data.length - 1,
                Math.floor((c - this.xStart) / (this.xSize / this.data.length))
              ));
        }),
        (d.prototype.onGridClick = function (a, b) {
          var c;
          ...
          return (
            ...
            this.options.horizontal
              ? ((f = this.left + 0.5 * this.width),
                ...
                [c, f, g, !0])
              : ((f = this.left + ((b + 0.5) * this.width) / this.data.length),
                [c, f])
          );
        }),
        (d.prototype.drawXAxisLabel = function (a, b, c) {
        ...
        if (
          ...
          (this.el = a(
            "string" == typeof c.element
              ? document.getElementById(c.element)
              : c.element
          )),
          null === this.el || 0 === this.el.length)
        )
