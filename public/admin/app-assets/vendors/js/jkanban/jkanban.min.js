      ...
      function (e, t, n) {
        ...
        !(function () {
          this.jKanban = function () {
            ...
            function E(e, t) {
              for (var n in t)
                -1 < b._disallowedItemProperties.indexOf(n) ||
                  e.setAttribute("data-" + n, t[n]);
            }
            arguments[0] &&
                    ...
                    ((b.drakeBoard = b
                      ...
                      .on("dragend", function (e) {
                        !(function () {
                          for (
                            var e = 1, t = 0;
                            t < b.container.childNodes.length;
                            t++
                          )
                      ...
                      .on("drop", function (e, t, n, r) {
                        e.classList.remove("is-moving"),
                          b.options.dropBoard(e, t, n, r),
                          "function" == typeof e.dropfn && e.dropfn(e, t, n, r);
                      })),
                    (b.drake = b
                      ...
                      .on("drag", function (e, t) {
                        ...
                        if ("" !== n && -1 < n.indexOf("not-draggable"))
                          b.drake.cancel(!0);
                        else {
                          e.classList.add("is-moving");
                      ...
                      .on("drop", function (e, t, n, r) {
                        ...
                        void 0 !== o.dragTo &&
                          -1 === o.dragTo.indexOf(t.parentNode.dataset.id) &&
                          t.parentNode.dataset.id !== n.parentNode.dataset.id &&
                          b.drake.cancel(!0),
                          null !== e &&
                            (!1 === b.options.dropEl(e, t, n, r) &&
                              b.drake.cancel(!0),
                            e.classList.remove("is-moving"),
                            "function" == typeof e.dropfn &&
                              e.dropfn(e, t, n, r));
                      })));
              }),
              ...
              (this.addElement = function (e, t) {
                var n = b.element.querySelector(
                    '[data-id="' + e + '"] .kanban-drag'
                  ),
              ...
              (this.addForm = function (e, t) {
                ...
                return (
                  t.setAttribute("class", r + " not-draggable"),
                  n.appendChild(t),
                  b
                );
              }),
              (this.addBoards = function (e, t) {
                ...
                for (var i in e) {
                  ...
                  if (
                    ...
                    (d.innerHTML =
                      '<div class="kanban-title-board">' + a.title + "</div>"),
                    r)
                  ) {
                  ...
                  if (
                    (f.classList.add("kanban-drag"),
                    "" !== a.bodyClass && void 0 !== a.bodyClass)
                  )
              ...
              (this.getParentBoardID = function (e) {
                return (
                  "string" == typeof e &&
                    (e = b.element.querySelector('[data-eid="' + e + '"]')),
              ...
              (this.replaceElement = function (e, t) {
                ...
                return (
                  "string" == typeof n &&
                    (n = b.element.querySelector('[data-eid="' + e + '"]')),
                  (n.innerHTML = t.title),
                  (n.clickfn = t.click),
                  (n.dragfn = t.drag),
              ...
              (this.getBoardElements = function (e) {
                return b.element.querySelector(
                  '[data-id="' + e + '"] .kanban-drag'
                ).childNodes;
              }),
              ...
              (this.removeBoard = function (e) {
                var t = null;
                "string" == typeof e &&
                  (t = b.element.querySelector('[data-id="' + e + '"]')),
                  null !== t && t.remove();
            ...
            ((e = function (e, t, n) {
              return e.attachEvent(
                ...
                (function (e, t, n) {
                  ...
                  return d.push({ wrapper: r, element: e, type: t, fn: n }), r;
                })(e, t, n)
              );
            }),
            (t = function (e, t, n) {
    ...
    8: [
      function (e, t, n) {
        ...
        function a(e) {
          var t = r[e];
          return (
            t ? (t.lastIndex = 0) : (r[e] = t = new RegExp(o + e + i, "g")), t
          );
        }
        t.exports = {
          add: function (e, t) {
        ...
        (function (o) {
          ...
          t.exports = function (e, t) {
            ...
            void 0 === T.moves && (T.moves = V),
              ...
              void 0 === T.ignoreInputTextSelection &&
                (T.ignoreInputTextSelection = !0),
            ...
            function k(e) {
              if (!((C.dragging && p) || d(e))) {
                ...
                if (n)
                  if (!T.invalid(e, t))
                    if (T.moves(e, n, t, Z(e))) return { item: e, source: n };
              }
            }
            function S(e) {
              !(function (e, t) {
                ...
                ((w = e.item.cloneNode(!0)),
                C.emit("cloned", w, e.item, "copy")),
                (v = e.source),
                (m = e.item),
                (b = y = Z(e.item)),
                (C.dragging = !0),
            ...
            function O(e) {
              if (C.dragging) {
                ...
                !1 === o &&
                  t &&
                  (w ? r && r.removeChild(w) : v.insertBefore(n, b)),
                  o || t
                    ? C.emit("cancel", n, v, v)
                    : C.emit("drop", n, r, v, y),
                  _();
            ...
            function _() {
              ...
              B(),
                p &&
                  (j.rm(T.mirrorContainer, "gu-unselectable"),
                  H(R, "remove", "mousemove", q),
                  J(p).removeChild(p),
                  (p = null)),
                e && j.rm(e, "gu-transit"),
                n && clearTimeout(n),
            ...
            function A(e, t) {
              var n;
              return (
                (n = void 0 !== t ? t : p ? y : Z(w || m)), e === v && n === b
              );
            }
            function P(n, r, o) {
              ...
              if (p) {
                ...
                if (c !== v || !w || T.copySortSource) {
                  ...
                  if (null !== s) l = X(c, s, t, n);
                    ...
                    if (!0 !== T.revertOnSpill || w)
                      return void (w && u && u.removeChild(i));
                    (l = b), (c = v);
                  }
                  ((null === l && d) || (l !== i && l !== Z(i))) &&
                    ((y = l), c.insertBefore(i, l), C.emit("shadow", i, c, v));
