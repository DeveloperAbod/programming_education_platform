    ...
    a =
      (new Chart(o, {
        ...
        options: {
          ...
          tooltips: {
            displayColors: !1,
            callbacks: { label: function (t, e) {}, title: function () {} },
          },
          legend: { display: !1 },
          scales: {
            ...
            yAxes: [
              {
                ticks: { padding: 10, stepSize: 5e3, max: 2e4, min: 0 },
                gridLines: {
                  display: !0,
                  drawBorder: !1,
                  lineWidth: 1,
  ...
  var r = Chart.controllers.doughnut.extend({
    draw: function () {
      ...
      (this.chart.ctx.fillStyle = "#ff0000"),
        "rtl" == $("html").data("textdirection") &&
          (n = Math.round((a - this.chart.ctx.measureText(l).width) / 1.15)),
  ...
  (o = document.getElementById("hit-rate-doughnut")),
    new Chart(o, {
      ...
      options: {
        ...
        cutoutPercentage: 92,
        animation: { animateScale: !1, duration: 2500 },
      },
    });
  ...
  (o = document.getElementById("deals-doughnut")),
    new Chart(o, {
      ...
      options: {
        ...
        layout: { padding: { left: 16, right: 16, top: 16, bottom: 16 } },
        cutoutPercentage: 94,
        animation: { animateScale: !1, duration: 5e3 },
      },
    });
