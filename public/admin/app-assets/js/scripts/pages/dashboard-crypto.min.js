!(function (e, t, a) {
  "use strict";
  var n = t.getElementById("btc-chartjs").getContext("2d");
  (r = n.createLinearGradient(0, 0, 0, 100)).addColorStop(
    0,
    "rgba(255, 145, 73,0.4)"
  ),
  ...
  var o = t.getElementById("eth-chartjs").getContext("2d");
  (r = o.createLinearGradient(0, 0, 0, 100)).addColorStop(
    0,
  ...
  var r,
    l = t.getElementById("xrp-chartjs").getContext("2d");
  (r = l.createLinearGradient(0, 0, 0, 100)).addColorStop(
    0,
    "rgba(30,159,242,0.4)"
  ),
    r.addColorStop(1, "rgba(255,255,255,0)");
  ...
  new ApexCharts(t.querySelector("#btc-candlestick-control"), i).render();
