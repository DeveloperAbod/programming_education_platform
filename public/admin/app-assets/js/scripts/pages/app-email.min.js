$(function () {
  ...
  if ($.app.menu.is_touch_device())
    ...
    if ($(".sidebar-menu-list").length > 0)
      new PerfectScrollbar(".sidebar-menu-list", { wheelPropagation: !1 });
    if (n.length > 0)
      new PerfectScrollbar(".email-user-list", { wheelPropagation: !1 });
    if ($(".email-scroll-area").length > 0)
      new PerfectScrollbar(".email-scroll-area", { wheelPropagation: !1 });
    if (a.length > 0)
  ...
  $(".mail-reply").on("click", function () {
    ...
    i.find(".mail-unread").on("click", function () {
      r.find("input:checked").closest("li").removeClass("mail-read"),
        i
          .find(".user-action .checkbox-con input:checked , .selectAll input")
          .prop("checked", "")
          .closest(".media")
          .removeClass("selected-row-bg");
    }),
    ...
    $(window).on("resize", function () {
      $(window).width() > 768 &&
        (s.hasClass("show") &&
          (o.removeClass("show"), s.removeClass("show"), a.removeClass("show")),
        $("#compose-form").find("input").val(""),
        ($(".custom-file .custom-file-label")[0].innerHTML = "Attach File"),
        ($("#compose-form .ql-editor")[0].innerHTML = ""));
    });
