$(window).on("load", function () {
  new PerfectScrollbar("#recent-buyers, #new-orders", { wheelPropagation: !0 });
  ...
  (function (e, t, a) {
    ...
    (n = function (e, t, a) {
      ...
      n.on("created", function (t) {
        var a = t.svg.querySelector("defs") || t.svg.elem("defs"),
          n =
            (t.svg.width(),
            t.svg.height(),
            a.elem("filter", { x: 0, y: "-10%", id: "shadow" + e }, "", !0));
        return (
          ...
          a
            ...
            .elem("stop", { offset: 0, "stop-color": "rgba(22, 141, 238, 1)" })
            .parent()
            .elem("stop", { offset: 1, "stop-color": "rgba(98, 188, 246, 1)" }),
          a
        );
      }).on("draw", function (t) {
        "line" === t.type
          ? t.element.attr({ filter: "url(#shadow" + e + ")" })
          : "point" === t.type &&
      ...
      (o = ["W1", "W2", "W4", "W5", "W6", "W7", "W8"]),
      (r = {
        name: "series-1",
        data: [77e3, 18e3, 61e3, 26e3, 58e3, 32e3, 7e4, 45e3],
      }),
      (l = ["AUG", "SEP", "OTC", "NOV", "DEC", "JAN", "FEB"]),
      (h = {
        name: "series-1",
      ...
      (c = function (e) {
        switch (
          (e || a("#ecommerceChartView .chart-action").find(".active")).attr(
            "href"
          )
        ) {
          case "#scoreLineToDay":
