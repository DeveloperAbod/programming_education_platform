$(document).ready(function () {
  ...
  var e = $(".draggable-start"),
    a = $(".draggable-drag"),
    t = $(".draggable-stop"),
    r = [0, 0, 0];
  function l(e, a) {
    e.hasClass("ui-state-hover") ||
      e.addClass("ui-state-hover").siblings().removeClass("ui-state-hover"),
      $("span.count", e).text(a);
  }
  e.draggable({
    start: function () {
    ...
    $(".resize-animate").resizable({ animate: !0 }),
    $(".resize-constrain").resizable({ containment: ".resize-container" }),
    $(".resize-aspect-ratio").resizable({ aspectRatio: 16 / 9 }),
    $(".selectable").selectable(),
    $(".selectable-serialize").selectable({
      stop: function () {
        var e = $(".select-result").empty();
        $(".ui-selected", this).each(function () {
          var a = $(".selectable-serialize li").index(this);
          e.append(" #" + (a + 1));
        });
      },
    }),
    ...
    $(".connect-list1, .connect-list2")
      .sortable({ connectWith: ".connectedSortable" })
      .disableSelection(),
    $(".sortable-placeholder").sortable({ placeholder: "ui-state-highlight" }),
    $(".sortable-placeholder").disableSelection(),
    $(".sortable-list1").sortable({ items: "li:not(.ui-state-disabled)" }),
    $(".sortable-list2").sortable({ cancel: ".ui-state-disabled" }),
