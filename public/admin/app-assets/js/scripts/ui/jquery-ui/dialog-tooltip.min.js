$(document).ready(function () {
  $(".default-dialog").dialog({ autoOpen: !1, width: 400 }),
    $(".animation-dialog").dialog({
      autoOpen: !1,
      width: 400,
      show: { effect: "fade", duration: 400 },
      hide: { effect: "explode", duration: 1e3 },
      modal: !0,
    }),
    $(".overlay-dialog").dialog({ autoOpen: !1, width: 400, modal: !0 }),
    ...
    $(".height-dialog").dialog({ autoOpen: !1, height: 400, modal: !0 }),
    $(".width-dialog").dialog({ autoOpen: !1, width: 500, modal: !0 }),
    $(".max-height-dialog").dialog({ autoOpen: !1, maxHeight: 400, modal: !0 }),
    $(".max-width-dialog").dialog({ autoOpen: !1, maxWidth: 600, modal: !0 }),
    $(".min-height-dialog").dialog({ autoOpen: !1, minHeight: 200, modal: !0 }),
    $(".min-width-dialog").dialog({ autoOpen: !1, minWidth: 200, modal: !0 }),
    $(".percent-width-dialog").dialog({
      autoOpen: !1,
      width: "50%",
      modal: !0,
    }),
    $(".full-width-dialog").dialog({ autoOpen: !1, width: "95%", modal: !0 }),
    ...
    $(".basic-form-dialog").dialog({ autoOpen: !1, width: 400, modal: !0 }),
    $(".grid-form-dialog").dialog({ autoOpen: !1, width: 500, modal: !0 }),
    $(".inline-form-dialog").dialog({ autoOpen: !1, width: 550, modal: !0 }),
    ...
    $(".custom-tooltip-animation").tooltip({
      ...
      open: function (o, t) {
        t.tooltip.animate({ top: t.tooltip.position().top + 10 }, "fast");
      },
    }),
    $(".tooltip-track-mouse").tooltip({ track: !0 }),
