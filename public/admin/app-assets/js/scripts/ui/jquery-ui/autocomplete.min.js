$(document).ready(function () {
  ...
  $(".ac-default").autocomplete({ source: e });
  var t = ["Jörn Zaefferer", "Scott González", "John Resig"],
    o = { á: "a", ö: "o" };
      ...
      _renderMenu: function (e, t) {
        ...
        $.each(t, function (t, n) {
          ...
          n.category != a &&
            ...
            (a = n.category)),
            (i = o._renderItemData(e, n)),
            n.category && i.attr("aria-label", n.category + " : " + n.label);
        });
      },
    });
    ...
    $.widget("custom.combobox", {
      ...
      _createAutocomplete: function () {
        ...
        (this.input = $("<input>")
          ...
          .attr("title", "")
          .addClass(
            "custom-combobox-input form-control ui-widget ui-widget-content ui-state-default ui-corner-left"
          )
          .autocomplete({
            delay: 0,
            minLength: 0,
      ...
      _removeIfInvalid: function (e, t) {
        if (!t.item) {
          ...
          this.element.children("option").each(function () {
            if ($(this).text().toLowerCase() === a)
              return (this.selected = n = !0), !1;
          }),
            n ||
              (this.input
                .val("")
                .attr("title", o + " didn't match any item")
                .tooltip("open"),
              this.element.val(""),
  ...
  ($(".ac-project")
    .autocomplete({
      ...
      focus: function (e, t) {
        return $(".ac-project").val(t.item.label), !1;
      },
      select: function (e, t) {
        return (
          $(".ac-project").val(t.item.label),
          $(".ac-project-id").val(t.item.value),
          $(".ac-project-description").html(t.item.desc),
          !1
        );
      },
    })
    ...
    return $("<li>")
      .append("<div>" + t.label + "<br>" + t.desc + "</div>")
      .appendTo(e);
  }),
    $(".ac-multiple-values")
      ...
      .autocomplete({
        minLength: 0,
        source: function (t, o) {
          o($.ui.autocomplete.filter(e, a(t.term).pop()));
        },
        focus: function () {
          return !1;
        },
    ...
    $(".ac-remote-datasource").autocomplete({
      source: "/admin/app-assets/data/jquery-ui/search.php",
      minLength: 2,
    });
  var n = {};
  function i(e) {
  ...
  $(".ac-remote-caching").autocomplete({
    ...
    source: function (e, t) {
      ...
      o in n
        ? t(n[o])
        : $.getJSON(
            "/admin/app-assets/data/jquery-ui/search.php",
            e,
            function (e, a, i) {
              (n[o] = e), t(e);
            }
    ...
    $(".ac-multiple-remote")
      ...
      .autocomplete({
        ...
        search: function () {
          if (r(this.value).length < 2) return !1;
        },
        focus: function () {
          return !1;
        },
    ...
    $.ajax({
      url: "/admin/app-assets/data/jquery-ui/london.xml",
      dataType: "xml",
      success: function (e) {
        var t = $("geoname", e)
          .map(function () {
          ...
          .get();
        $(".ac-xml-data-parse").autocomplete({ source: t, minLength: 0 });
      },
    });
});
