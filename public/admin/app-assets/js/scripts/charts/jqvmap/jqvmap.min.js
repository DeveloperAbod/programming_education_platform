$(window).on("load", function () {
  ...
  var e,
    l = {
      mo: o('<div class="map-pin red"><span>MO</span></div>'),
      fl: o('<div class="map-pin blue"><span>FL</span></div>'),
      or: o('<div class="map-pin purple"><span>OR</span></div>'),
    };
  jQuery("#custom-pins").vectorMap({
    ...
    jQuery(document).ready(function () {
      var o = "fl",
        l = ["mo", "fl", "or"];
      e = jQuery("#inactive-regions").vectorMap({
        map: "usa_en",
        backgroundColor: "#FFF",
        borderColor: "#FFF",
        enableZoom: !0,
        ...
        selectedRegions: ["fl"],
        hoverColor: null,
        colors: { mo: "#2A363B", fl: "#2A363B", or: "#2A363B" },
        onRegionClick: function (e, a, n) {
          -1 === l.indexOf(a) || o === a ? e.preventDefault() : (o = a);
        },
        onRegionSelect: function (o, l, a) {
          console.log(e.selectedRegions);
        },
        onLabelShow: function (o, e, a) {
          -1 === l.indexOf(a) && o.preventDefault();
        },
      });
    }),
