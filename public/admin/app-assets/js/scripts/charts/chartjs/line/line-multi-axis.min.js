$(window).on("load", function () {
  ...
  new Chart(i, {
    ...
    options: {
      ...
      hoverMode: "label",
      stacked: !1,
      title: { display: !0, text: "Chart.js Line Chart - Multi Axis" },
      scales: {
        xAxes: [
          {
            display: !0,
            gridLines: { offsetGridLines: !1, color: "#f3f3f3", drawTicks: !1 },
        ...
        yAxes: [
          ...
          },
          {
            ...
            position: "right",
            id: "y-axis-2",
            gridLines: { drawOnChartArea: !1, color: "#f3f3f3", drawTicks: !1 },
          },
        ],
      },
    },
