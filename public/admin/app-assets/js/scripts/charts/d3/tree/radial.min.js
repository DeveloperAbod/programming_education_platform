$(window).on("load", function () {
  var t = d3
    ...
    r = d3.svg.diagonal.radial().projection(function (t) {
      return [t.y, (t.x / 180) * Math.PI];
    });
  d3.json("/admin/app-assets/data/d3/tree/radial-tree.json", function (a, n) {
    var s = e.nodes(n),
      d = e.links(s),
      l =
        (t
    ...
    l
      ...
      l
        ...
        .attr("transform", function (t) {
          return t.x < 180 ? "translate(8)" : "rotate(180)translate(-8)";
        })
        .style("font-size", 12)
        .text(function (t) {
          return t.name;
