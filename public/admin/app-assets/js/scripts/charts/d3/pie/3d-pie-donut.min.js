$(window).on("load", function () {
  var t = d3.select("#pie-3d"),
    e = d3.select("#donut-3d"),
    l = t.node().getBoundingClientRect().width,
    o = 500,
    a = e.node().getBoundingClientRect().width,
    n = 500,
    d = t.append("svg").attr("width", l).attr("height", o),
    i = e.append("svg").attr("width", a).attr("height", n);
  function u() {
    (l = t.node().getBoundingClientRect().width),
      (a = e.node().getBoundingClientRect().width),
      (pie_x = l / 2),
      ...
      d.attr("width", l),
      d3
        .select("#quotesDonut g")
        .attr("transform", "translate(" + pie_x + "," + pie_y + ")"),
      i.attr("width", a),
      d3
        .select("#salesDonut g")
        .attr("transform", "translate(" + donut_x + "," + donut_y + ")");
  }
  d.append("g").attr("id", "quotesDonut"),
    i.append("g").attr("id", "salesDonut"),
    Donut3D.draw(
      "quotesDonut",
      [
