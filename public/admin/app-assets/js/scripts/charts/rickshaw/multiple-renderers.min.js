$(window).on("load", function () {
  for (
    var e = [[], [], [], [], []],
      r = new Rickshaw.Fixtures.RandomData(50),
      a = 0;
    a < 75;
    a++
  )
  ...
  var n = new Rickshaw.Graph({
    ...
    series: [
      ...
      {
        name: "pop",
        data: e.shift().map(function (e) {
          return { x: e.x, y: e.y / 4 };
        }),
  ...
  new Rickshaw.Graph.Behavior.Series.Highlight({
    ...
    new Rickshaw.Graph.Behavior.Series.Toggle({ graph: n, legend: t });
});
