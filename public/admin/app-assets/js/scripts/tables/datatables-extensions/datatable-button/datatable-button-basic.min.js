$(document).ready(function () {
      ...
      buttons: [
        {
          ...
          buttons: [
            "colvis",
            {
              ...
              className: "my-1",
              action: function (t, a, n, e) {
                a.column(-2).visible(!a.column(-2).visible());
              },
            },
            {
              text: "Toggle salary",
              className: "my-1",
              action: function (t, a, n, e) {
                a.column(-1).visible(!a.column(-1).visible());
              },
            },
            {
  ...
  var t = $(".data-multiple-buttongroups").DataTable({
    dom: "Bfrtip",
    buttons: [
      {
        text: "Button 1",
  ...
  new $.fn.dataTable.Buttons(t, {
    ...
    t.buttons(1, null).container().appendTo(t.table().container()),
