$(document).ready(function () {
  var e = $(".main-demo-image"),
    o = ($(".download"), $(".main-demo-dataX")),
    r = $(".main-demo-dataY"),
  ...
  e.cropper(p),
    ...
    $(".basic-cropper").cropper({ viewMode: 1, restore: !1, zoomOnWheel: !1 }),
    $(".no-overlay").cropper({
      viewMode: 1,
      modal: !1,
      restore: !1,
