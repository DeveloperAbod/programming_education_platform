$(document).ready(function () {
  ...
  $(".copy-btn").on("click", function () {
    ...
    ($.fn.scrollToBottom = function () {
      return this.scrollTop(this[0].scrollHeight), this;
    });
  $(".elStatus").on("idle.idleTimer", function (t, e, o) {
    t.stopPropagation(),
      $(".elStatus")
        .val(function (t, e) {
        ...
        $(".elStatus")
          .val(function (t, e) {
            return (
              e +
              "State: " +
              ($(".elStatus").idleTimer("isIdle") ? "idle" : "active") +
              " \n"
            );
          })
          .scrollToBottom(),
    ...
    $(".elStatus")
      .val("")
      .idleTimer({ timeout: 3e3, timerSyncId: "element-timer-demo" }),
    $(".elStatus").idleTimer("isIdle")
      ? $(".elStatus")
          .val(function (t, e) {
      ...
      : $(".elStatus")
          ...
          .scrollToBottom(),
    $(".elTimeout").text(3);
  $(document).on("idle.idleTimer", function (t, e, o) {
    $(".docStatus")
      .val(function (t, e) {
        return e + "Idle @ " + moment().format() + " \n";
      })
    ...
    $(document).on("active.idleTimer", function (t, e, o, n) {
      $(".docStatus")
        .val(function (t, e) {
          return (
            e +
    ...
    $(".docStatus").val(""),
    $(document).idleTimer({ timeout: 5e3, timerSyncId: "document-timer-demo" }),
    $(document).idleTimer("isIdle")
      ? $(".docStatus")
          .val(function (t, e) {
