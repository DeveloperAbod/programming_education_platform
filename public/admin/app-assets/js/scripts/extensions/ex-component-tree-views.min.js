$(document).ready(function () {
  var e = "#5A8DEE",
    ...
    c = [
        ...
        nodes: [
          {
            ...
            tags: ["2"],
            nodes: [
              { text: "Grandchild 1", tags: ["0"] },
              { text: "Grandchild 2", tags: ["0"] },
            ],
          },
          { text: "Child 2", tags: ["3"] },
        ],
      ...
      },
      {
        ...
        color: ["#fff"],
        backColor: "#FDAC41",
        href: "http://www.Abod.com",
        tags: ["0", "available"],
      },
    ];
  $("#default-treeview").treeview({ selectedBackColor: [e], data: t }),
  ...
  var a = $("#disabled-treeview").treeview({ selectedBackColor: [e], data: t });
  $("#btn-disable-all").on("click", function (e) {
    a.treeview("disableAll", {
      silent: $("#chk-disable-silent").is(":checked"),
    });
  }),
    $("#btn-enable-all").on("click", function (e) {
      a.treeview("enableAll", {
        silent: $("#chk-disable-silent").is(":checked"),
      });
    });
  ...
  var o = $("#searchable-tree").treeview({
      selectedBackColor: [e],
      color: [e],
      showBorder: !0,
      data: t,
    ...
    r = function (e) {
      var t = $("#input-search").val(),
        ...
        a = o.treeview("search", [t, c]),
        r = "<p>" + a.length + " matches found</p>";
      $.each(a, function (e, t) {
        r += "<p>- " + t.text + "</p>";
      }),
        $("#search-output").html(r);
    };
  $("#btn-search").on("click", r),
    $("#input-search").on("keyup", r),
    $("#btn-clear-search").on("click", function (e) {
      o.treeview("clearSearch"),
        $("#input-search").val(""),
        $("#search-output").html("");
    });
  var l = $("#expandible-tree").treeview({ selectedBackColor: [e], data: t });
  $("#btn-expand-all").on("click", function (e) {
    $("#select-expand-all-levels").val();
    l.treeview("expandAll", { levels: 2 });
  }),
    $("#btn-collapse-all").on("click", function (e) {
      l.treeview("collapseAll");
    });
  var n = $("#checkable-tree").treeview({
    selectedBackColor: [e],
    data: t,
    showIcon: !1,
    showCheckbox: !0,
  ...
  $("#btn-check-all").on("click", function (e) {
    n.treeview("checkAll", { silent: $("#chk-check-silent").is(":checked") });
  }),
    $("#btn-uncheck-all").on("click", function (e) {
      n.treeview("uncheckAll", {
