!(function (e, o, a) {
  "use strict";
  var t = o.getElementById("emp-satisfaction").getContext("2d"),
  ...
  var i = o.getElementById("line-stacked-area").getContext("2d"),
    l =
      (new Chart(i, {
        type: "line",
        options: {
            ...
            yAxes: [
              {
                ...
                ticks: { display: !1, maxTicksLimit: 5 },
              },
            ],
          },
      ...
      o.getElementById("earning-chart").getContext("2d")),
    n =
      (new Chart(l, {
        type: "line",
        options: {
    ...
    s =
      ...
      o.getElementById("global-sales").getContext("2d")),
    d = t.createLinearGradient(0, 0, 0, 400);
  d.addColorStop(0, "rgba(248, 238, 44, 1)"),
    d.addColorStop(0.6, "rgba(255, 162, 0, 1)"),
    d.addColorStop(1, "rgba(243, 97, 0, 1)");
  new Chart(s, {
    type: "bar",
    options: {
      responsive: !0,
        ...
        xAxes: [
          {
            ...
            stacked: !0,
            gridLines: { display: !1, drawTicks: !1, drawBorder: !1 },
          ...
          },
          {
            ...
            id: "fmv",
            categoryPercentage: 0.6,
            gridLines: { display: !1, offsetGridLines: !0, drawBorder: !1 },
            stacked: !0,
            ticks: { fontSize: 14, fontColor: "transparent" },
          },
        ],
        yAxes: [
          {
            ...
            ticks: { fontColor: "#FFF", min: 0, max: 3e3 },
          },
        ],
      },
    },
    ...
    options: {
      ...
      scales: {
        ...
        yAxes: [
          {
            display: !0,
            gridLines: { color: "rgba(255, 255, 255, 0.3)", drawTicks: !1 },
            ticks: { fontColor: "#FFF" },
          },
        ],
      },
  ...
  Morris.Area({
    ...
    Morris.Bar({
      ...
      data: [
        { device: "iPhone 7", sales: 1835 },
        { device: "Note 7", sales: 2356 },
        { device: "Mi5", sales: 1459 },
        { device: "Moto Z", sales: 1289 },
        { device: "Lenovo X3", sales: 1647 },
        { device: "OnePlus 3", sales: 2156 },
      ],
      xkey: "device",
      ykeys: ["sales"],
      labels: ["Sales"],
  ...
  new Chart(b, {
    ...
    options: {
      ...
      scales: {
        xAxes: [
          { display: !1, scaleLabel: { display: !0, labelString: "Month" } },
        ],
        yAxes: [{ display: !0 }],
      },
      title: { display: !1, text: "Radar Chart" },
    },
    data: {
      labels: [
        "Radio",
  ...
  new Chartist.Line(
    ...
    },
    {
      ...
      showPoint: !0,
      showLabel: !1,
      axisX: { showGrid: !1, showLabel: !1, offset: 0 },
      axisY: { showGrid: !1, showLabel: !1, offset: 0 },
      chartPadding: 0,
    ...
    if (
      ("area" === e.type &&
        e.element.attr({ style: "fill: #28D094; fill-opacity: 0.2" }),
      "line" === e.type &&
        e.element.attr({
