$(document).ready(function () {
  $(".case-sensitive").tagging({ "case-sensitive": !0 }),
    $(".close-char").tagging({ "close-char": "" }),
    $(".edit-on-delete").tagging({ "edit-on-delete": !1 }),
    $(".no-duplicate").tagging({ "no-duplicate": !1 }),
    $(".no-enter").tagging({ "no-enter": !0 }),
    $(".no-comma").tagging({ "no-comma": !0 }),
    $(".forbidden-chars").tagging({ "forbidden-chars": [",", ".", "_", "?"] }),
    $(".forbidden-words").tagging({
      "forbidden-words": ["bastard", "bitch", "biatch", "bloody"],
    }),
    $(".pre-tags-separator").tagging({ "pre-tags-separator": "/" }),
    $(".tag-on-blur").tagging({ "tag-on-blur": !1 }),
    $(".tag-char").tagging({ "tag-char": "*" }),
    $(".type-zone-class").tagging({ "type-zone-class": "tagging-area" }),
    $(".add-box").tagging(),
    $(".remove-box").tagging();
  ...
  (a = a[0]),
    ...
    $(".add-special-keys").on("click", function () {
      $(".special-keys-box").tagging("addSpecialKeys", [
        "add",
        { right_arrow: 39 },
      ]),
        $(".special-keys-box").tagging("addSpecialKeys", [
